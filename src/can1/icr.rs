...
impl ERRDIR_R {
    ...
    pub fn variant(&self) -> ERRDIR_A {
        match self.bits {
            false => ERRDIR_A::TRANSMIT_ERROR,
            true => ERRDIR_A::RECEIVE_ERROR,
        }
    }
    #[doc = "Checks if the value of the field is `TRANSMIT_ERROR`"]
    #[inline(always)]
    pub fn is_transmit_error(&self) -> bool {
        *self == ERRDIR_A::TRANSMIT_ERROR
    }
    #[doc = "Checks if the value of the field is `RECEIVE_ERROR`"]
    #[inline(always)]
    pub fn is_receive_error(&self) -> bool {
        *self == ERRDIR_A::RECEIVE_ERROR
    }
}
