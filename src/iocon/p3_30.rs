#[doc = "Reader of register P3_30"]
pub type R = crate::R<u32, super::P3_30>;
#[doc = "Writer for register P3_30"]
pub type W = crate::W<u32, super::P3_30>;
#[doc = "Register P3_30 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_30 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[30\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_30 = 0,
    #[doc = "1: External memory data line 30."]
    EMC_D_30 = 1,
    #[doc = "2: Request to Send output for UART1. Can also be                                             configured to be an RS-485/EIA-485 output enable signal                                             for UART1."]
    U1_RTS = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_30),
            1 => Val(FUNC_A::EMC_D_30),
            2 => Val(FUNC_A::U1_RTS),
            3 => Val(FUNC_A::T1_MAT1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_30`"]
    #[inline(always)]
    pub fn is_p3_30(&self) -> bool {
        *self == FUNC_A::P3_30
    }
    #[doc = "Checks if the value of the field is `EMC_D_30`"]
    #[inline(always)]
    pub fn is_emc_d_30(&self) -> bool {
        *self == FUNC_A::EMC_D_30
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_30(self) -> &'a mut W {
        self.variant(FUNC_A::P3_30)
    }
    #[doc = "External memory data line 30."]
    #[inline(always)]
    pub fn emc_d_30(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_30)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[30\\]"]
    #[inline(always)]
