#[doc = "Reader of register P3_25"]
pub type R = crate::R<u32, super::P3_25>;
#[doc = "Writer for register P3_25"]
pub type W = crate::W<u32, super::P3_25>;
#[doc = "Register P3_25 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_25 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[25\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_25 = 0,
    #[doc = "1: External memory data line 25."]
    EMC_D_25 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 2."]
    PWM1_2 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_25),
            1 => Val(FUNC_A::EMC_D_25),
            2 => Val(FUNC_A::PWM1_2),
            3 => Val(FUNC_A::T0_MAT0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_25`"]
    #[inline(always)]
    pub fn is_p3_25(&self) -> bool {
        *self == FUNC_A::P3_25
    }
    #[doc = "Checks if the value of the field is `EMC_D_25`"]
    #[inline(always)]
    pub fn is_emc_d_25(&self) -> bool {
        *self == FUNC_A::EMC_D_25
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_25(self) -> &'a mut W {
        self.variant(FUNC_A::P3_25)
    }
    #[doc = "External memory data line 25."]
    #[inline(always)]
    pub fn emc_d_25(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_25)
    }
    #[doc = "Pulse Width Modulator 1, output 2."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[25\\]"]
    #[inline(always)]
