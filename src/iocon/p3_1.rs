#[doc = "Reader of register P3_1"]
pub type R = crate::R<u32, super::P3_1>;
#[doc = "Writer for register P3_1"]
pub type W = crate::W<u32, super::P3_1>;
#[doc = "Register P3_1 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[1\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_1 = 0,
    #[doc = "1: External memory data line 1."]
    EMC_D_1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_1),
            1 => Val(FUNC_A::EMC_D_1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_1`"]
    #[inline(always)]
    pub fn is_p3_1(&self) -> bool {
        *self == FUNC_A::P3_1
    }
    #[doc = "Checks if the value of the field is `EMC_D_1`"]
    #[inline(always)]
    pub fn is_emc_d_1(&self) -> bool {
        *self == FUNC_A::EMC_D_1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_1(self) -> &'a mut W {
        self.variant(FUNC_A::P3_1)
    }
    #[doc = "External memory data line 1."]
    #[inline(always)]
    pub fn emc_d_1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[1\\]"]
    #[inline(always)]
