#[doc = "Reader of register P0_28"]
pub type R = crate::R<u32, super::P0_28>;
#[doc = "Writer for register P0_28"]
pub type W = crate::W<u32, super::P0_28>;
#[doc = "Register P0_28 `reset()`'s with value 0x80"]
impl crate::ResetValue for super::P0_28 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_28),
            1 => Val(FUNC_A::I2C0_SCL),
            2 => Val(FUNC_A::USB_SCL1),
            i => Res(i),
        }
    }
