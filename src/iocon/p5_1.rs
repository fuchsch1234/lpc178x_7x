#[doc = "Reader of register P5_1"]
pub type R = crate::R<u32, super::P5_1>;
#[doc = "Writer for register P5_1"]
pub type W = crate::W<u32, super::P5_1>;
#[doc = "Register P5_1 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P5_1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P5\\[1\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P5_1 = 0,
    #[doc = "1: External memory address line 25."]
    EMC_A_25 = 1,
    #[doc = "2: Master In Slave Out for SSP2."]
    SSP2_MISO = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P5_1),
            1 => Val(FUNC_A::EMC_A_25),
            2 => Val(FUNC_A::SSP2_MISO),
            3 => Val(FUNC_A::T2_MAT3),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P5_1`"]
    #[inline(always)]
    pub fn is_p5_1(&self) -> bool {
        *self == FUNC_A::P5_1
    }
    #[doc = "Checks if the value of the field is `EMC_A_25`"]
    #[inline(always)]
    pub fn is_emc_a_25(&self) -> bool {
        *self == FUNC_A::EMC_A_25
    }
    #[doc = "Checks if the value of the field is `SSP2_MISO`"]
    #[inline(always)]
    pub fn is_ssp2_miso(&self) -> bool {
        *self == FUNC_A::SSP2_MISO
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p5_1(self) -> &'a mut W {
        self.variant(FUNC_A::P5_1)
    }
    #[doc = "External memory address line 25."]
    #[inline(always)]
    pub fn emc_a_25(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_25)
    }
    #[doc = "Master In Slave Out for SSP2."]
    #[inline(always)]
    pub fn ssp2_miso(self) -> &'a mut W {
        self.variant(FUNC_A::SSP2_MISO)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P5\\[1\\]"]
    #[inline(always)]
