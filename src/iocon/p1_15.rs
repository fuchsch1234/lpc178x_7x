#[doc = "Reader of register P1_15"]
pub type R = crate::R<u32, super::P1_15>;
#[doc = "Writer for register P1_15"]
pub type W = crate::W<u32, super::P1_15>;
#[doc = "Register P1_15 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_15 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[15\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_15 = 0,
    #[doc = "1: Ethernet Receive Clock (MII interface) or                                             Ethernet Reference Clock (RMII interface)."]
    ENET_RX_CLK_REF_CLK = 1,
    #[doc = "3: I2C2 data input/output                                             (this pin does not use a specialized I2C                                             pad)."]
    I2C2_SDA = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_15),
            1 => Val(FUNC_A::ENET_RX_CLK_REF_CLK),
            3 => Val(FUNC_A::I2C2_SDA),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_15`"]
    #[inline(always)]
    pub fn is_p1_15(&self) -> bool {
        *self == FUNC_A::P1_15
    }
    #[doc = "Checks if the value of the field is `ENET_RX_CLK_REF_CLK`"]
    #[inline(always)]
    pub fn is_enet_rx_clk_ref_clk(&self) -> bool {
        *self == FUNC_A::ENET_RX_CLK_REF_CLK
    }
    #[doc = "Checks if the value of the field is `I2C2_SDA`"]
    #[inline(always)]
    pub fn is_i2c2_sda(&self) -> bool {
        *self == FUNC_A::I2C2_SDA
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_15(self) -> &'a mut W {
        self.variant(FUNC_A::P1_15)
    }
    #[doc = "Ethernet Receive Clock (MII interface) or Ethernet Reference Clock (RMII interface)."]
    #[inline(always)]
    pub fn enet_rx_clk_ref_clk(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RX_CLK_REF_CLK)
    }
    #[doc = "I2C2 data input/output (this pin does not use a specialized I2C pad)."]
    #[inline(always)]
    pub fn i2c2_sda(self) -> &'a mut W {
        self.variant(FUNC_A::I2C2_SDA)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[15\\]"]
    #[inline(always)]
