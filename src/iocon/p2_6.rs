#[doc = "Reader of register P2_6"]
pub type R = crate::R<u32, super::P2_6>;
#[doc = "Writer for register P2_6"]
pub type W = crate::W<u32, super::P2_6>;
#[doc = "Register P2_6 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_6 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P2_6`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_6(self) -> &'a mut W {
        self.variant(FUNC_A::P2_6)
    }
    ...
    pub fn u2_oe(self) -> &'a mut W {
        self.variant(FUNC_A::U2_OE)
    }
    #[doc = "Trace clock."]
    #[inline(always)]
    pub fn traceclk(self) -> &'a mut W {
        self.variant(FUNC_A::TRACECLK)
    }
    #[doc = "LCD data."]
    #[inline(always)]
