#[doc = "Reader of register P2_30"]
pub type R = crate::R<u32, super::P2_30>;
#[doc = "Writer for register P2_30"]
pub type W = crate::W<u32, super::P2_30>;
#[doc = "Register P2_30 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_30 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[30\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_30 = 0,
    #[doc = "1: Data mask 2 used with SDRAM and static                                             devices."]
    EMC_DQM2 = 1,
    #[doc = "2: I2C2 data input/output                                             (this pin does not use a specialized I2C                                             pad)."]
    I2C2_SDA = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_30),
            1 => Val(FUNC_A::EMC_DQM2),
            2 => Val(FUNC_A::I2C2_SDA),
            3 => Val(FUNC_A::T3_MAT2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_30`"]
    #[inline(always)]
    pub fn is_p2_30(&self) -> bool {
        *self == FUNC_A::P2_30
    }
    #[doc = "Checks if the value of the field is `EMC_DQM2`"]
    #[inline(always)]
    pub fn is_emc_dqm2(&self) -> bool {
        *self == FUNC_A::EMC_DQM2
    }
    ...
    #[doc = "Checks if the value of the field is `T3_MAT2`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_30(self) -> &'a mut W {
        self.variant(FUNC_A::P2_30)
    }
    #[doc = "Data mask 2 used with SDRAM and static devices."]
    #[inline(always)]
    pub fn emc_dqm2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DQM2)
    }
    ...
    #[inline(always)]
    pub fn t3_mat2(self) -> &'a mut W {
        self.variant(FUNC_A::T3_MAT2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[30\\]"]
    #[inline(always)]
