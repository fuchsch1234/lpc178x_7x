#[doc = "Reader of register P0_2"]
pub type R = crate::R<u32, super::P0_2>;
#[doc = "Writer for register P0_2"]
pub type W = crate::W<u32, super::P0_2>;
#[doc = "Register P0_2 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_2 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[2\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_2 = 0,
    #[doc = "1: Transmitter output for UART0."]
    U0_TXD = 1,
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P0_2`"]
    #[inline(always)]
    pub fn is_p0_2(&self) -> bool {
        *self == FUNC_A::P0_2
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_2(self) -> &'a mut W {
        self.variant(FUNC_A::P0_2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[2\\]"]
    #[inline(always)]
