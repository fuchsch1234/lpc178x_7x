#[doc = "Reader of register P2_22"]
pub type R = crate::R<u32, super::P2_22>;
#[doc = "Writer for register P2_22"]
pub type W = crate::W<u32, super::P2_22>;
#[doc = "Register P2_22 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_22 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[22\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_22 = 0,
    #[doc = "1: SDRAM chip select 2."]
    EMC_DYCS2 = 1,
    #[doc = "2: Serial clock for SSP0."]
    SSP0_SCK = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_22),
            1 => Val(FUNC_A::EMC_DYCS2),
            2 => Val(FUNC_A::SSP0_SCK),
            3 => Val(FUNC_A::T3_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_22`"]
    #[inline(always)]
    pub fn is_p2_22(&self) -> bool {
        *self == FUNC_A::P2_22
    }
    #[doc = "Checks if the value of the field is `EMC_DYCS2`"]
    #[inline(always)]
    pub fn is_emc_dycs2(&self) -> bool {
        *self == FUNC_A::EMC_DYCS2
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_22(self) -> &'a mut W {
        self.variant(FUNC_A::P2_22)
    }
    #[doc = "SDRAM chip select 2."]
    #[inline(always)]
    pub fn emc_dycs2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DYCS2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[22\\]"]
    #[inline(always)]
