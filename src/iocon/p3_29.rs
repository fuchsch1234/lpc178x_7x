#[doc = "Reader of register P3_29"]
pub type R = crate::R<u32, super::P3_29>;
#[doc = "Writer for register P3_29"]
pub type W = crate::W<u32, super::P3_29>;
#[doc = "Register P3_29 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_29 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[29\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_29 = 0,
    #[doc = "1: External memory data line 29."]
    EMC_D_29 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 6."]
    PWM1_6 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_29),
            1 => Val(FUNC_A::EMC_D_29),
            2 => Val(FUNC_A::PWM1_6),
            3 => Val(FUNC_A::T1_MAT0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_29`"]
    #[inline(always)]
    pub fn is_p3_29(&self) -> bool {
        *self == FUNC_A::P3_29
    }
    #[doc = "Checks if the value of the field is `EMC_D_29`"]
    #[inline(always)]
    pub fn is_emc_d_29(&self) -> bool {
        *self == FUNC_A::EMC_D_29
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_29(self) -> &'a mut W {
        self.variant(FUNC_A::P3_29)
    }
    #[doc = "External memory data line 29."]
    #[inline(always)]
    pub fn emc_d_29(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_29)
    }
    #[doc = "Pulse Width Modulator 1, output 6."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[29\\]"]
    #[inline(always)]
