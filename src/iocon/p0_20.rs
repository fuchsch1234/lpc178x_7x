#[doc = "Reader of register P0_20"]
pub type R = crate::R<u32, super::P0_20>;
#[doc = "Writer for register P0_20"]
pub type W = crate::W<u32, super::P0_20>;
#[doc = "Register P0_20 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_20 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[20\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_20 = 0,
    #[doc = "1: Data Terminal Ready output for UART1. Can also be                                             configured to be an RS-485/EIA-485 output enable signal                                             for UART1."]
    U1_DTR = 1,
    #[doc = "2: Command line for SD card interface."]
    SD_CMD = 2,
    #[doc = "3: I2C1 clock                                             input/output (this pin does not use a specialized I2C                                             pad)."]
    I2C1_SCL = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNC_A::U1_DTR),
            2 => Val(FUNC_A::SD_CMD),
            3 => Val(FUNC_A::I2C1_SCL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_20`"]
    #[inline(always)]
    pub fn is_p0_20(&self) -> bool {
        *self == FUNC_A::P0_20
    }
    ...
    #[doc = "Checks if the value of the field is `SD_CMD`"]
    #[inline(always)]
    pub fn is_sd_cmd(&self) -> bool {
        *self == FUNC_A::SD_CMD
    }
    #[doc = "Checks if the value of the field is `I2C1_SCL`"]
    #[inline(always)]
    pub fn is_i2c1_scl(&self) -> bool {
        *self == FUNC_A::I2C1_SCL
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_20(self) -> &'a mut W {
        self.variant(FUNC_A::P0_20)
    }
    ...
    #[doc = "Command line for SD card interface."]
    #[inline(always)]
    pub fn sd_cmd(self) -> &'a mut W {
        self.variant(FUNC_A::SD_CMD)
    }
    #[doc = "I2C1 clock input/output (this pin does not use a specialized I2C pad)."]
    #[inline(always)]
    pub fn i2c1_scl(self) -> &'a mut W {
        self.variant(FUNC_A::I2C1_SCL)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[20\\]"]
    #[inline(always)]
