#[doc = "Reader of register P1_10"]
pub type R = crate::R<u32, super::P1_10>;
#[doc = "Writer for register P1_10"]
pub type W = crate::W<u32, super::P1_10>;
#[doc = "Register P1_10 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_10 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[10\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_10 = 0,
    #[doc = "1: Ethernet receive data 1 (RMII/MII                                             interface)."]
    ENET_RXD1 = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_10),
            1 => Val(FUNC_A::ENET_RXD1),
            3 => Val(FUNC_A::T3_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_10`"]
    #[inline(always)]
    pub fn is_p1_10(&self) -> bool {
        *self == FUNC_A::P1_10
    }
    #[doc = "Checks if the value of the field is `ENET_RXD1`"]
    #[inline(always)]
    pub fn is_enet_rxd1(&self) -> bool {
        *self == FUNC_A::ENET_RXD1
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_10(self) -> &'a mut W {
        self.variant(FUNC_A::P1_10)
    }
    #[doc = "Ethernet receive data 1 (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_rxd1(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RXD1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[10\\]"]
    #[inline(always)]
