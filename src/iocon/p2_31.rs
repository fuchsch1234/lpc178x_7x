#[doc = "Reader of register P2_31"]
pub type R = crate::R<u32, super::P2_31>;
#[doc = "Writer for register P2_31"]
pub type W = crate::W<u32, super::P2_31>;
#[doc = "Register P2_31 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_31 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[31\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_31 = 0,
    #[doc = "1: Data mask 3 used with SDRAM and static                                             devices."]
    EMC_DQM3 = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_31),
            1 => Val(FUNC_A::EMC_DQM3),
            2 => Val(FUNC_A::I2C2_SCL),
            3 => Val(FUNC_A::T3_MAT3),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_31`"]
    #[inline(always)]
    pub fn is_p2_31(&self) -> bool {
        *self == FUNC_A::P2_31
    }
    #[doc = "Checks if the value of the field is `EMC_DQM3`"]
    #[inline(always)]
    pub fn is_emc_dqm3(&self) -> bool {
        *self == FUNC_A::EMC_DQM3
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_31(self) -> &'a mut W {
        self.variant(FUNC_A::P2_31)
    }
    #[doc = "Data mask 3 used with SDRAM and static devices."]
    #[inline(always)]
    pub fn emc_dqm3(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DQM3)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[31\\]"]
    #[inline(always)]
