#[doc = "Reader of register P1_16"]
pub type R = crate::R<u32, super::P1_16>;
#[doc = "Writer for register P1_16"]
pub type W = crate::W<u32, super::P1_16>;
#[doc = "Register P1_16 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_16 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[16\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_16 = 0,
    #[doc = "1: Ethernet MIIM clock."]
    ENET_MDC = 1,
    #[doc = "2: I2S transmit master clock."]
    I2S_TX_MCLK = 2,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_16),
            1 => Val(FUNC_A::ENET_MDC),
            2 => Val(FUNC_A::I2S_TX_MCLK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_16`"]
    #[inline(always)]
    pub fn is_p1_16(&self) -> bool {
        *self == FUNC_A::P1_16
    }
    ...
    #[doc = "Checks if the value of the field is `I2S_TX_MCLK`"]
    #[inline(always)]
    pub fn is_i2s_tx_mclk(&self) -> bool {
        *self == FUNC_A::I2S_TX_MCLK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_16(self) -> &'a mut W {
        self.variant(FUNC_A::P1_16)
    }
    ...
    #[doc = "I2S transmit master clock."]
    #[inline(always)]
    pub fn i2s_tx_mclk(self) -> &'a mut W {
        self.variant(FUNC_A::I2S_TX_MCLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[16\\]"]
    #[inline(always)]
