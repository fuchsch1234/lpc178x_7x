#[doc = "Reader of register P2_14"]
pub type R = crate::R<u32, super::P2_14>;
#[doc = "Writer for register P2_14"]
pub type W = crate::W<u32, super::P2_14>;
#[doc = "Register P2_14 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_14 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[14\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_14 = 0,
    #[doc = "1: LOW active Chip Select 2 signal."]
    EMC_CS2 = 1,
    #[doc = "2: I2C1 data input/output                                             (this pin does not use a specialized I2C                                             pad)."]
    I2C1_SDA = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_14),
            1 => Val(FUNC_A::EMC_CS2),
            2 => Val(FUNC_A::I2C1_SDA),
            3 => Val(FUNC_A::T2_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_14`"]
    #[inline(always)]
    pub fn is_p2_14(&self) -> bool {
        *self == FUNC_A::P2_14
    }
    #[doc = "Checks if the value of the field is `EMC_CS2`"]
    #[inline(always)]
    pub fn is_emc_cs2(&self) -> bool {
        *self == FUNC_A::EMC_CS2
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_14(self) -> &'a mut W {
        self.variant(FUNC_A::P2_14)
    }
    #[doc = "LOW active Chip Select 2 signal."]
    #[inline(always)]
    pub fn emc_cs2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CS2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[14\\]"]
    #[inline(always)]
