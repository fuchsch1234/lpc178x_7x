#[doc = "Reader of register P1_11"]
pub type R = crate::R<u32, super::P1_11>;
#[doc = "Writer for register P1_11"]
pub type W = crate::W<u32, super::P1_11>;
#[doc = "Register P1_11 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_11 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[11\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_11 = 0,
    #[doc = "1: Ethernet Receive Data 2 (MII                                             interface)."]
    ENET_RXD2 = 1,
    #[doc = "2: Data line 2 for SD card interface."]
    SD_DAT_2 = 2,
    #[doc = "3: Pulse Width Modulator 0, output 6."]
    PWM0_6 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_11),
            1 => Val(FUNC_A::ENET_RXD2),
            2 => Val(FUNC_A::SD_DAT_2),
            3 => Val(FUNC_A::PWM0_6),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_11`"]
    #[inline(always)]
    pub fn is_p1_11(&self) -> bool {
        *self == FUNC_A::P1_11
    }
    #[doc = "Checks if the value of the field is `ENET_RXD2`"]
    #[inline(always)]
    pub fn is_enet_rxd2(&self) -> bool {
        *self == FUNC_A::ENET_RXD2
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_11(self) -> &'a mut W {
        self.variant(FUNC_A::P1_11)
    }
    #[doc = "Ethernet Receive Data 2 (MII interface)."]
    #[inline(always)]
    pub fn enet_rxd2(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RXD2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[11\\]"]
    #[inline(always)]
