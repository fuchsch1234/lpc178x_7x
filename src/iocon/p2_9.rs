#[doc = "Reader of register P2_9"]
pub type R = crate::R<u32, super::P2_9>;
#[doc = "Writer for register P2_9"]
pub type W = crate::W<u32, super::P2_9>;
#[doc = "Register P2_9 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_9 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[9\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_9 = 0,
    #[doc = "1: USB1 SoftConnect control. Signal used to switch                                             an external 1.5 kW resistor                                             under the software control. Used with the SoftConnect                                             USB feature."]
    USB_CONNECT1 = 1,
    #[doc = "2: Receiver input for UART2."]
    U2_RXD = 2,
    #[doc = "3: Receiver input for USART4."]
    U4_RXD = 3,
    #[doc = "4: Ethernet MIIM data input and output."]
    ENET_MDIO = 4,
    #[doc = "6: LCD data."]
    LCD_VD_3 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_9),
            1 => Val(FUNC_A::USB_CONNECT1),
            2 => Val(FUNC_A::U2_RXD),
            3 => Val(FUNC_A::U4_RXD),
            4 => Val(FUNC_A::ENET_MDIO),
            6 => Val(FUNC_A::LCD_VD_3),
            7 => Val(FUNC_A::LCD_VD_7),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_9`"]
    #[inline(always)]
    pub fn is_p2_9(&self) -> bool {
        *self == FUNC_A::P2_9
    }
    #[doc = "Checks if the value of the field is `USB_CONNECT1`"]
    #[inline(always)]
    pub fn is_usb_connect1(&self) -> bool {
        *self == FUNC_A::USB_CONNECT1
    }
    #[doc = "Checks if the value of the field is `U2_RXD`"]
    #[inline(always)]
    pub fn is_u2_rxd(&self) -> bool {
        *self == FUNC_A::U2_RXD
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_9(self) -> &'a mut W {
        self.variant(FUNC_A::P2_9)
    }
    #[doc = "USB1 SoftConnect control. Signal used to switch an external 1.5 kW resistor under the software control. Used with the SoftConnect USB feature."]
    #[inline(always)]
    pub fn usb_connect1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_CONNECT1)
    }
    #[doc = "Receiver input for UART2."]
    #[inline(always)]
    pub fn u2_rxd(self) -> &'a mut W {
        self.variant(FUNC_A::U2_RXD)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[9\\]"]
    #[inline(always)]
