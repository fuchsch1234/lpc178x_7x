#[doc = "Reader of register P1_14"]
pub type R = crate::R<u32, super::P1_14>;
#[doc = "Writer for register P1_14"]
pub type W = crate::W<u32, super::P1_14>;
#[doc = "Register P1_14 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_14 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[14\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_14 = 0,
    #[doc = "1: Ethernet receive error (RMII/MII                                             interface)."]
    ENET_RX_ER = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_14),
            1 => Val(FUNC_A::ENET_RX_ER),
            3 => Val(FUNC_A::T2_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_14`"]
    #[inline(always)]
    pub fn is_p1_14(&self) -> bool {
        *self == FUNC_A::P1_14
    }
    #[doc = "Checks if the value of the field is `ENET_RX_ER`"]
    #[inline(always)]
    pub fn is_enet_rx_er(&self) -> bool {
        *self == FUNC_A::ENET_RX_ER
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_14(self) -> &'a mut W {
        self.variant(FUNC_A::P1_14)
    }
    #[doc = "Ethernet receive error (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_rx_er(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RX_ER)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[14\\]"]
    #[inline(always)]
