#[doc = "Reader of register P4_31"]
pub type R = crate::R<u32, super::P4_31>;
#[doc = "Writer for register P4_31"]
pub type W = crate::W<u32, super::P4_31>;
#[doc = "Register P4_31 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_31 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[31\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_31 = 0,
    #[doc = "1: LOW active Chip Select 1 signal."]
    EMC_CS1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_31),
            1 => Val(FUNC_A::EMC_CS1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_31`"]
    #[inline(always)]
    pub fn is_p4_31(&self) -> bool {
        *self == FUNC_A::P4_31
    }
    #[doc = "Checks if the value of the field is `EMC_CS1`"]
    #[inline(always)]
    pub fn is_emc_cs1(&self) -> bool {
        *self == FUNC_A::EMC_CS1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_31(self) -> &'a mut W {
        self.variant(FUNC_A::P4_31)
    }
    #[doc = "LOW active Chip Select 1 signal."]
    #[inline(always)]
    pub fn emc_cs1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CS1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[31\\]"]
    #[inline(always)]
