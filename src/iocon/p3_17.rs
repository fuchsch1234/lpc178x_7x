#[doc = "Reader of register P3_17"]
pub type R = crate::R<u32, super::P3_17>;
#[doc = "Writer for register P3_17"]
pub type W = crate::W<u32, super::P3_17>;
#[doc = "Register P3_17 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_17 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[17\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_17 = 0,
    #[doc = "1: External memory data line 17."]
    EMC_D_17 = 1,
    #[doc = "2: Pulse Width Modulator 0, output 2."]
    PWM0_2 = 2,
    #[doc = "3: Receiver input for UART1."]
    U1_RXD = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_17),
            1 => Val(FUNC_A::EMC_D_17),
            2 => Val(FUNC_A::PWM0_2),
            3 => Val(FUNC_A::U1_RXD),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_17`"]
    #[inline(always)]
    pub fn is_p3_17(&self) -> bool {
        *self == FUNC_A::P3_17
    }
    #[doc = "Checks if the value of the field is `EMC_D_17`"]
    #[inline(always)]
    pub fn is_emc_d_17(&self) -> bool {
        *self == FUNC_A::EMC_D_17
    }
    ...
    #[doc = "Checks if the value of the field is `U1_RXD`"]
    #[inline(always)]
    pub fn is_u1_rxd(&self) -> bool {
        *self == FUNC_A::U1_RXD
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_17(self) -> &'a mut W {
        self.variant(FUNC_A::P3_17)
    }
    #[doc = "External memory data line 17."]
    #[inline(always)]
    pub fn emc_d_17(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_17)
    }
    ...
    #[doc = "Receiver input for UART1."]
    #[inline(always)]
    pub fn u1_rxd(self) -> &'a mut W {
        self.variant(FUNC_A::U1_RXD)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[17\\]"]
    #[inline(always)]
