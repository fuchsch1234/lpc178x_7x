#[doc = "Reader of register P1_3"]
pub type R = crate::R<u32, super::P1_3>;
#[doc = "Writer for register P1_3"]
pub type W = crate::W<u32, super::P1_3>;
#[doc = "Register P1_3 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_3 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[3\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_3 = 0,
    #[doc = "1: Ethernet transmit data 3 (MII                                             interface)."]
    ENET_TXD3 = 1,
    #[doc = "2: Command line for SD card interface."]
    SD_CMD = 2,
    #[doc = "3: Pulse Width Modulator 0, output 2."]
    PWM0_2 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_3),
            1 => Val(FUNC_A::ENET_TXD3),
            2 => Val(FUNC_A::SD_CMD),
            3 => Val(FUNC_A::PWM0_2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_3`"]
    #[inline(always)]
    pub fn is_p1_3(&self) -> bool {
        *self == FUNC_A::P1_3
    }
    #[doc = "Checks if the value of the field is `ENET_TXD3`"]
    #[inline(always)]
    pub fn is_enet_txd3(&self) -> bool {
        *self == FUNC_A::ENET_TXD3
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_3(self) -> &'a mut W {
        self.variant(FUNC_A::P1_3)
    }
    #[doc = "Ethernet transmit data 3 (MII interface)."]
    #[inline(always)]
    pub fn enet_txd3(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TXD3)
    }
    ...
    #[doc = "Pulse Width Modulator 0, output 2."]
    #[inline(always)]
    pub fn pwm0_2(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[3\\]"]
    #[inline(always)]
