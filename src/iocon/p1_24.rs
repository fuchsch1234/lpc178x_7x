#[doc = "Reader of register P1_24"]
pub type R = crate::R<u32, super::P1_24>;
#[doc = "Writer for register P1_24"]
pub type W = crate::W<u32, super::P1_24>;
#[doc = "Register P1_24 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_24 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_24`"]
    #[inline(always)]
    pub fn is_p1_24(&self) -> bool {
        *self == FUNC_A::P1_24
    }
    #[doc = "Checks if the value of the field is `USB_RX_DM1`"]
    #[inline(always)]
    pub fn is_usb_rx_dm1(&self) -> bool {
        *self == FUNC_A::USB_RX_DM1
    }
    ...
    #[doc = "Checks if the value of the field is `QEI_IDX`"]
    #[inline(always)]
    pub fn is_qei_idx(&self) -> bool {
        *self == FUNC_A::QEI_IDX
    }
    #[doc = "Checks if the value of the field is `MC_FB2`"]
    #[inline(always)]
    pub fn is_mc_fb2(&self) -> bool {
        *self == FUNC_A::MC_FB2
    }
    #[doc = "Checks if the value of the field is `SSP0_MOSI`"]
    #[inline(always)]
    pub fn is_ssp0_mosi(&self) -> bool {
        *self == FUNC_A::SSP0_MOSI
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_24(self) -> &'a mut W {
        self.variant(FUNC_A::P1_24)
    }
    #[doc = "D- receive data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_rx_dm1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_RX_DM1)
    }
    ...
    #[inline(always)]
    pub fn qei_idx(self) -> &'a mut W {
        self.variant(FUNC_A::QEI_IDX)
    }
    #[doc = "Motor control PWM channel 2 feedback input."]
    #[inline(always)]
    pub fn mc_fb2(self) -> &'a mut W {
        self.variant(FUNC_A::MC_FB2)
    }
    #[doc = "Master Out Slave in for SSP0."]
    #[inline(always)]
    pub fn ssp0_mosi(self) -> &'a mut W {
        self.variant(FUNC_A::SSP0_MOSI)
    }
    #[doc = "LCD data."]
    #[inline(always)]
