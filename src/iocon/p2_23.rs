#[doc = "Reader of register P2_23"]
pub type R = crate::R<u32, super::P2_23>;
#[doc = "Writer for register P2_23"]
pub type W = crate::W<u32, super::P2_23>;
#[doc = "Register P2_23 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_23 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[23\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_23 = 0,
    #[doc = "1: SDRAM chip select 3."]
    EMC_DYCS3 = 1,
    #[doc = "2: Slave Select for SSP0."]
    SSP0_SSEL = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_23),
            1 => Val(FUNC_A::EMC_DYCS3),
            2 => Val(FUNC_A::SSP0_SSEL),
            3 => Val(FUNC_A::T3_CAP1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_23`"]
    #[inline(always)]
    pub fn is_p2_23(&self) -> bool {
        *self == FUNC_A::P2_23
    }
    #[doc = "Checks if the value of the field is `EMC_DYCS3`"]
    #[inline(always)]
    pub fn is_emc_dycs3(&self) -> bool {
        *self == FUNC_A::EMC_DYCS3
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_23(self) -> &'a mut W {
        self.variant(FUNC_A::P2_23)
    }
    #[doc = "SDRAM chip select 3."]
    #[inline(always)]
    pub fn emc_dycs3(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DYCS3)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[23\\]"]
    #[inline(always)]
