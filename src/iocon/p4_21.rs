#[doc = "Reader of register P4_21"]
pub type R = crate::R<u32, super::P4_21>;
#[doc = "Writer for register P4_21"]
pub type W = crate::W<u32, super::P4_21>;
#[doc = "Register P4_21 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_21 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[21\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_21 = 0,
    #[doc = "1: External memory address line 21."]
    EMC_A_21 = 1,
    #[doc = "2: I2C2 clock                                             input/output (this pin does not use a specialized I2C                                             pad)."]
    I2C2_SCL = 2,
    #[doc = "3: Slave Select for SSP1."]
    SSP1_SSEL = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_21),
            1 => Val(FUNC_A::EMC_A_21),
            2 => Val(FUNC_A::I2C2_SCL),
            3 => Val(FUNC_A::SSP1_SSEL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_21`"]
    #[inline(always)]
    pub fn is_p4_21(&self) -> bool {
        *self == FUNC_A::P4_21
    }
    #[doc = "Checks if the value of the field is `EMC_A_21`"]
    #[inline(always)]
    pub fn is_emc_a_21(&self) -> bool {
        *self == FUNC_A::EMC_A_21
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_21(self) -> &'a mut W {
        self.variant(FUNC_A::P4_21)
    }
    #[doc = "External memory address line 21."]
    #[inline(always)]
    pub fn emc_a_21(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_21)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[21\\]"]
    #[inline(always)]
