#[doc = "Reader of register P0_10"]
pub type R = crate::R<u32, super::P0_10>;
#[doc = "Writer for register P0_10"]
pub type W = crate::W<u32, super::P0_10>;
#[doc = "Register P0_10 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_10 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            3 => Val(FUNC_A::T3_MAT0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_10`"]
    #[inline(always)]
    pub fn is_p0_10(&self) -> bool {
        *self == FUNC_A::P0_10
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_10(self) -> &'a mut W {
        self.variant(FUNC_A::P0_10)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[10\\]"]
    #[inline(always)]
