#[doc = "Reader of register P0_17"]
pub type R = crate::R<u32, super::P0_17>;
#[doc = "Writer for register P0_17"]
pub type W = crate::W<u32, super::P0_17>;
#[doc = "Register P0_17 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_17 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[17\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_17 = 0,
    #[doc = "1: Clear to Send input for UART1."]
    U1_CTS = 1,
    #[doc = "2: Master In Slave Out for SSP0."]
    SSP0_MISO = 2,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_17),
            1 => Val(FUNC_A::U1_CTS),
            2 => Val(FUNC_A::SSP0_MISO),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_17`"]
    #[inline(always)]
    pub fn is_p0_17(&self) -> bool {
        *self == FUNC_A::P0_17
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_17(self) -> &'a mut W {
        self.variant(FUNC_A::P0_17)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[17\\]"]
    #[inline(always)]
