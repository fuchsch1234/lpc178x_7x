#[doc = "Reader of register P1_5"]
pub type R = crate::R<u32, super::P1_5>;
#[doc = "Writer for register P1_5"]
pub type W = crate::W<u32, super::P1_5>;
#[doc = "Register P1_5 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_5 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[5\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_5 = 0,
    #[doc = "1: Ethernet Transmit Error (MII                                             interface)."]
    ENET_TX_ER = 1,
    #[doc = "2: Power Supply Enable for external SD card power                                             supply."]
    SD_PWR = 2,
    #[doc = "3: Pulse Width Modulator 0, output 3."]
    PWM0_3 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_5),
            1 => Val(FUNC_A::ENET_TX_ER),
            2 => Val(FUNC_A::SD_PWR),
            3 => Val(FUNC_A::PWM0_3),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_5`"]
    #[inline(always)]
    pub fn is_p1_5(&self) -> bool {
        *self == FUNC_A::P1_5
    }
    #[doc = "Checks if the value of the field is `ENET_TX_ER`"]
    #[inline(always)]
    pub fn is_enet_tx_er(&self) -> bool {
        *self == FUNC_A::ENET_TX_ER
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_5(self) -> &'a mut W {
        self.variant(FUNC_A::P1_5)
    }
    #[doc = "Ethernet Transmit Error (MII interface)."]
    #[inline(always)]
    pub fn enet_tx_er(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TX_ER)
    }
    ...
    #[doc = "Pulse Width Modulator 0, output 3."]
    #[inline(always)]
    pub fn pwm0_3(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_3)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[5\\]"]
    #[inline(always)]
