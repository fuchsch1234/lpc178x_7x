#[doc = "Reader of register P2_20"]
pub type R = crate::R<u32, super::P2_20>;
#[doc = "Writer for register P2_20"]
pub type W = crate::W<u32, super::P2_20>;
#[doc = "Register P2_20 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_20 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[20\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_20 = 0,
    #[doc = "1: SDRAM chip select 0."]
    EMC_DYCS0 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_20),
            1 => Val(FUNC_A::EMC_DYCS0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_20`"]
    #[inline(always)]
    pub fn is_p2_20(&self) -> bool {
        *self == FUNC_A::P2_20
    }
    #[doc = "Checks if the value of the field is `EMC_DYCS0`"]
    #[inline(always)]
    pub fn is_emc_dycs0(&self) -> bool {
        *self == FUNC_A::EMC_DYCS0
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_20(self) -> &'a mut W {
        self.variant(FUNC_A::P2_20)
    }
    #[doc = "SDRAM chip select 0."]
    #[inline(always)]
    pub fn emc_dycs0(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DYCS0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[20\\]"]
    #[inline(always)]
