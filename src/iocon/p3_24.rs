#[doc = "Reader of register P3_24"]
pub type R = crate::R<u32, super::P3_24>;
#[doc = "Writer for register P3_24"]
pub type W = crate::W<u32, super::P3_24>;
#[doc = "Register P3_24 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_24 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[24\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_24 = 0,
    #[doc = "1: External memory data line 24."]
    EMC_D_24 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 1."]
    PWM1_1 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_24),
            1 => Val(FUNC_A::EMC_D_24),
            2 => Val(FUNC_A::PWM1_1),
            3 => Val(FUNC_A::T0_CAP1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_24`"]
    #[inline(always)]
    pub fn is_p3_24(&self) -> bool {
        *self == FUNC_A::P3_24
    }
    #[doc = "Checks if the value of the field is `EMC_D_24`"]
    #[inline(always)]
    pub fn is_emc_d_24(&self) -> bool {
        *self == FUNC_A::EMC_D_24
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_24(self) -> &'a mut W {
        self.variant(FUNC_A::P3_24)
    }
    #[doc = "External memory data line 24."]
    #[inline(always)]
    pub fn emc_d_24(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_24)
    }
    #[doc = "Pulse Width Modulator 1, output 1."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[24\\]"]
    #[inline(always)]
