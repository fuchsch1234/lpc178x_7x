#[doc = "Reader of register P2_0"]
pub type R = crate::R<u32, super::P2_0>;
#[doc = "Writer for register P2_0"]
pub type W = crate::W<u32, super::P2_0>;
#[doc = "Register P2_0 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[0\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_0 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 1                                             output."]
    PWM1_1 = 1,
    #[doc = "2: Transmitter output for UART1."]
    U1_TXD = 2,
    #[doc = "7: LCD panel power enable."]
    LCD_PWR = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNC_A::PWM1_1),
            2 => Val(FUNC_A::U1_TXD),
            7 => Val(FUNC_A::LCD_PWR),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_0`"]
    #[inline(always)]
    pub fn is_p2_0(&self) -> bool {
        *self == FUNC_A::P2_0
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_PWR`"]
    #[inline(always)]
    pub fn is_lcd_pwr(&self) -> bool {
        *self == FUNC_A::LCD_PWR
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_0(self) -> &'a mut W {
        self.variant(FUNC_A::P2_0)
    }
    ...
    #[doc = "LCD panel power enable."]
    #[inline(always)]
    pub fn lcd_pwr(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_PWR)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[0\\]"]
    #[inline(always)]
