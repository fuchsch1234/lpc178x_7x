#[doc = "Reader of register P1_29"]
pub type R = crate::R<u32, super::P1_29>;
#[doc = "Writer for register P1_29"]
pub type W = crate::W<u32, super::P1_29>;
#[doc = "Register P1_29 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_29 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[29\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_29 = 0,
    #[doc = "1: USB port 1 I2C serial                                             data (OTG transceiver)."]
    USB_SDA1 = 1,
    #[doc = "2: Capture input for PWM1, channel 1."]
    PWM1_CAP1 = 2,
    #[doc = "3: Match output for Timer 0, channel 1."]
    T0_MAT1 = 3,
    #[doc = "4: Motor control PWM channel 2, output                                             B."]
    MC_2B = 4,
    #[doc = "5: Transmitter output for USART4 (input/output in                                             smart card mode)."]
    U4_TXD = 5,
    #[doc = "6: LCD data."]
    LCD_VD_15 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_29`"]
    #[inline(always)]
    pub fn is_p1_29(&self) -> bool {
        *self == FUNC_A::P1_29
    }
    ...
    #[doc = "Checks if the value of the field is `PWM1_CAP1`"]
    #[inline(always)]
    pub fn is_pwm1_cap1(&self) -> bool {
        *self == FUNC_A::PWM1_CAP1
    }
    #[doc = "Checks if the value of the field is `T0_MAT1`"]
    #[inline(always)]
    pub fn is_t0_mat1(&self) -> bool {
        *self == FUNC_A::T0_MAT1
    }
    #[doc = "Checks if the value of the field is `MC_2B`"]
    #[inline(always)]
    pub fn is_mc_2b(&self) -> bool {
        *self == FUNC_A::MC_2B
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_VD_15`"]
    #[inline(always)]
    pub fn is_lcd_vd_15(&self) -> bool {
        *self == FUNC_A::LCD_VD_15
    }
    #[doc = "Checks if the value of the field is `LCD_VD_23`"]
    #[inline(always)]
    pub fn is_lcd_vd_23(&self) -> bool {
        *self == FUNC_A::LCD_VD_23
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_29(self) -> &'a mut W {
        self.variant(FUNC_A::P1_29)
    }
    #[doc = "USB port 1 I2C serial data (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_sda1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_SDA1)
    }
    #[doc = "Capture input for PWM1, channel 1."]
    #[inline(always)]
    pub fn pwm1_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_CAP1)
    }
    #[doc = "Match output for Timer 0, channel 1."]
    #[inline(always)]
    pub fn t0_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::T0_MAT1)
    }
    #[doc = "Motor control PWM channel 2, output B."]
    #[inline(always)]
    pub fn mc_2b(self) -> &'a mut W {
        self.variant(FUNC_A::MC_2B)
    }
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_15(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_15)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_23(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_23)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[29\\]"]
    #[inline(always)]
