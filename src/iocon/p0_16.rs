#[doc = "Reader of register P0_16"]
pub type R = crate::R<u32, super::P0_16>;
#[doc = "Writer for register P0_16"]
pub type W = crate::W<u32, super::P0_16>;
#[doc = "Register P0_16 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_16 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[16\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_16 = 0,
    #[doc = "1: Receiver input for UART1."]
    U1_RXD = 1,
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P0_16`"]
    #[inline(always)]
    pub fn is_p0_16(&self) -> bool {
        *self == FUNC_A::P0_16
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_16(self) -> &'a mut W {
        self.variant(FUNC_A::P0_16)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[16\\]"]
    #[inline(always)]
