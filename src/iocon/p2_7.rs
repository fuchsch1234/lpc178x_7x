#[doc = "Reader of register P2_7"]
pub type R = crate::R<u32, super::P2_7>;
#[doc = "Writer for register P2_7"]
pub type W = crate::W<u32, super::P2_7>;
#[doc = "Register P2_7 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_7 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[7\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_7 = 0,
    #[doc = "1: CAN2 receiver input."]
    CAN_RD2 = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_7),
            1 => Val(FUNC_A::CAN_RD2),
            2 => Val(FUNC_A::U1_RTS),
            6 => Val(FUNC_A::LCD_VD_1),
            7 => Val(FUNC_A::LCD_VD_5),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_7`"]
    #[inline(always)]
    pub fn is_p2_7(&self) -> bool {
        *self == FUNC_A::P2_7
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_VD_1`"]
    #[inline(always)]
    pub fn is_lcd_vd_1(&self) -> bool {
        *self == FUNC_A::LCD_VD_1
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_7(self) -> &'a mut W {
        self.variant(FUNC_A::P2_7)
    }
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_1(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_1)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[7\\]"]
    #[inline(always)]
