#[doc = "Reader of register P4_2"]
pub type R = crate::R<u32, super::P4_2>;
#[doc = "Writer for register P4_2"]
pub type W = crate::W<u32, super::P4_2>;
#[doc = "Register P4_2 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_2 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[2\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_2 = 0,
    #[doc = "1: External memory address line 2."]
    EMC_A_2 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_2),
            1 => Val(FUNC_A::EMC_A_2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_2`"]
    #[inline(always)]
    pub fn is_p4_2(&self) -> bool {
        *self == FUNC_A::P4_2
    }
    #[doc = "Checks if the value of the field is `EMC_A_2`"]
    #[inline(always)]
    pub fn is_emc_a_2(&self) -> bool {
        *self == FUNC_A::EMC_A_2
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_2(self) -> &'a mut W {
        self.variant(FUNC_A::P4_2)
    }
    #[doc = "External memory address line 2."]
    #[inline(always)]
    pub fn emc_a_2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[2\\]"]
    #[inline(always)]
