#[doc = "Reader of register P1_6"]
pub type R = crate::R<u32, super::P1_6>;
#[doc = "Writer for register P1_6"]
pub type W = crate::W<u32, super::P1_6>;
#[doc = "Register P1_6 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_6 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[6\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_6 = 0,
    #[doc = "1: Ethernet Transmit Clock (MII                                             interface)."]
    ENET_TX_CLK = 1,
    #[doc = "2: Data line 0 for SD card interface."]
    SD_DAT_0 = 2,
    #[doc = "3: Pulse Width Modulator 0, output 4."]
    PWM0_4 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_6),
            1 => Val(FUNC_A::ENET_TX_CLK),
            2 => Val(FUNC_A::SD_DAT_0),
            3 => Val(FUNC_A::PWM0_4),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_6`"]
    #[inline(always)]
    pub fn is_p1_6(&self) -> bool {
        *self == FUNC_A::P1_6
    }
    #[doc = "Checks if the value of the field is `ENET_TX_CLK`"]
    #[inline(always)]
    pub fn is_enet_tx_clk(&self) -> bool {
        *self == FUNC_A::ENET_TX_CLK
    }
    ...
    #[doc = "Checks if the value of the field is `PWM0_4`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_6(self) -> &'a mut W {
        self.variant(FUNC_A::P1_6)
    }
    #[doc = "Ethernet Transmit Clock (MII interface)."]
    #[inline(always)]
    pub fn enet_tx_clk(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TX_CLK)
    }
    ...
    #[inline(always)]
    pub fn pwm0_4(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_4)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[6\\]"]
    #[inline(always)]
