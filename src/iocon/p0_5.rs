#[doc = "Reader of register P0_5"]
pub type R = crate::R<u32, super::P0_5>;
#[doc = "Writer for register P0_5"]
pub type W = crate::W<u32, super::P0_5>;
#[doc = "Register P0_5 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_5 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_5),
            1 => Val(FUNC_A::I2S_RX_WS),
            2 => Val(FUNC_A::CAN_TD2),
            3 => Val(FUNC_A::T2_CAP1),
            7 => Val(FUNC_A::LCD_VD_1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_5`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_5(self) -> &'a mut W {
        self.variant(FUNC_A::P0_5)
    }
