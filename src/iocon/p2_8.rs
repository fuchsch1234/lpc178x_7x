#[doc = "Reader of register P2_8"]
pub type R = crate::R<u32, super::P2_8>;
#[doc = "Writer for register P2_8"]
pub type W = crate::W<u32, super::P2_8>;
#[doc = "Register P2_8 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_8 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[8\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_8 = 0,
    #[doc = "1: CAN2 transmitter output."]
    CAN_TD2 = 1,
    #[doc = "2: Transmitter output for UART2."]
    U2_TXD = 2,
    #[doc = "3: Clear to Send input for UART1."]
    U1_CTS = 3,
    #[doc = "4: Ethernet MIIM clock."]
    ENET_MDC = 4,
    #[doc = "6: LCD data."]
    LCD_VD_2 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_8),
            1 => Val(FUNC_A::CAN_TD2),
            2 => Val(FUNC_A::U2_TXD),
            3 => Val(FUNC_A::U1_CTS),
            4 => Val(FUNC_A::ENET_MDC),
            6 => Val(FUNC_A::LCD_VD_2),
            7 => Val(FUNC_A::LCD_VD_6),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_8`"]
    #[inline(always)]
    pub fn is_p2_8(&self) -> bool {
        *self == FUNC_A::P2_8
    }
    #[doc = "Checks if the value of the field is `CAN_TD2`"]
    #[inline(always)]
    pub fn is_can_td2(&self) -> bool {
        *self == FUNC_A::CAN_TD2
    }
    #[doc = "Checks if the value of the field is `U2_TXD`"]
    #[inline(always)]
    pub fn is_u2_txd(&self) -> bool {
        *self == FUNC_A::U2_TXD
    }
    #[doc = "Checks if the value of the field is `U1_CTS`"]
    #[inline(always)]
    pub fn is_u1_cts(&self) -> bool {
        *self == FUNC_A::U1_CTS
    }
    #[doc = "Checks if the value of the field is `ENET_MDC`"]
    #[inline(always)]
    pub fn is_enet_mdc(&self) -> bool {
        *self == FUNC_A::ENET_MDC
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_8(self) -> &'a mut W {
        self.variant(FUNC_A::P2_8)
    }
    #[doc = "CAN2 transmitter output."]
    #[inline(always)]
    pub fn can_td2(self) -> &'a mut W {
        self.variant(FUNC_A::CAN_TD2)
    }
    #[doc = "Transmitter output for UART2."]
    #[inline(always)]
    pub fn u2_txd(self) -> &'a mut W {
        self.variant(FUNC_A::U2_TXD)
    }
    #[doc = "Clear to Send input for UART1."]
    #[inline(always)]
    pub fn u1_cts(self) -> &'a mut W {
        self.variant(FUNC_A::U1_CTS)
    }
    #[doc = "Ethernet MIIM clock."]
    #[inline(always)]
    pub fn enet_mdc(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_MDC)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[8\\]"]
    #[inline(always)]
