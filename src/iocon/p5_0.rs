#[doc = "Reader of register P5_0"]
pub type R = crate::R<u32, super::P5_0>;
#[doc = "Writer for register P5_0"]
pub type W = crate::W<u32, super::P5_0>;
#[doc = "Register P5_0 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P5_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P5\\[0\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P5_0 = 0,
    #[doc = "1: External memory address line 24."]
    EMC_A_24 = 1,
    #[doc = "2: Master Out Slave In for SSP2."]
    SSP2_MOSI = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P5_0),
            1 => Val(FUNC_A::EMC_A_24),
            2 => Val(FUNC_A::SSP2_MOSI),
            3 => Val(FUNC_A::T2_MAT2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P5_0`"]
    #[inline(always)]
    pub fn is_p5_0(&self) -> bool {
        *self == FUNC_A::P5_0
    }
    #[doc = "Checks if the value of the field is `EMC_A_24`"]
    #[inline(always)]
    pub fn is_emc_a_24(&self) -> bool {
        *self == FUNC_A::EMC_A_24
    }
    #[doc = "Checks if the value of the field is `SSP2_MOSI`"]
    #[inline(always)]
    pub fn is_ssp2_mosi(&self) -> bool {
        *self == FUNC_A::SSP2_MOSI
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p5_0(self) -> &'a mut W {
        self.variant(FUNC_A::P5_0)
    }
    #[doc = "External memory address line 24."]
    #[inline(always)]
    pub fn emc_a_24(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_24)
    }
    #[doc = "Master Out Slave In for SSP2."]
    #[inline(always)]
    pub fn ssp2_mosi(self) -> &'a mut W {
        self.variant(FUNC_A::SSP2_MOSI)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P5\\[0\\]"]
    #[inline(always)]
