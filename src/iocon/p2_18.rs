#[doc = "Reader of register P2_18"]
pub type R = crate::R<u32, super::P2_18>;
#[doc = "Writer for register P2_18"]
pub type W = crate::W<u32, super::P2_18>;
#[doc = "Register P2_18 `reset()`'s with value 0x01b0"]
impl crate::ResetValue for super::P2_18 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_18),
            1 => Val(FUNC_A::EMC_CLK_0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_18`"]
    #[inline(always)]
    pub fn is_p2_18(&self) -> bool {
        *self == FUNC_A::P2_18
    }
    #[doc = "Checks if the value of the field is `EMC_CLK_0`"]
    #[inline(always)]
    pub fn is_emc_clk_0(&self) -> bool {
        *self == FUNC_A::EMC_CLK_0
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_18(self) -> &'a mut W {
        self.variant(FUNC_A::P2_18)
    }
    #[doc = "SDRAM clock 0."]
    #[inline(always)]
    pub fn emc_clk_0(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CLK_0)
    }
