#[doc = "Reader of register P4_14"]
pub type R = crate::R<u32, super::P4_14>;
#[doc = "Writer for register P4_14"]
pub type W = crate::W<u32, super::P4_14>;
#[doc = "Register P4_14 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_14 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_14),
            1 => Val(FUNC_A::EMC_A_14),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_14`"]
    #[inline(always)]
    pub fn is_p4_14(&self) -> bool {
        *self == FUNC_A::P4_14
    }
    #[doc = "Checks if the value of the field is `EMC_A_14`"]
    #[inline(always)]
    pub fn is_emc_a_14(&self) -> bool {
        *self == FUNC_A::EMC_A_14
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_14(self) -> &'a mut W {
        self.variant(FUNC_A::P4_14)
    }
    #[doc = "External memory address line 14."]
    #[inline(always)]
    pub fn emc_a_14(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_14)
    }
