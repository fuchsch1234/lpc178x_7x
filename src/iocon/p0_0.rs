#[doc = "Reader of register P0_0"]
pub type R = crate::R<u32, super::P0_0>;
#[doc = "Writer for register P0_0"]
pub type W = crate::W<u32, super::P0_0>;
#[doc = "Register P0_0 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[0\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_0 = 0,
    #[doc = "1: CAN1 receiver input."]
    CAN_RD1 = 1,
    #[doc = "2: Transmitter output for UART3."]
    U3_TXD = 2,
    #[doc = "3: I2C1 data input/output(this pin does not use a specialized I2C                                             pad)."]
    I2C1_SDA = 3,
    #[doc = "4: Transmitter output for UART0."]
    U0_TXD = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_0),
            1 => Val(FUNC_A::CAN_RD1),
            2 => Val(FUNC_A::U3_TXD),
            3 => Val(FUNC_A::I2C1_SDA),
            4 => Val(FUNC_A::U0_TXD),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_0`"]
    #[inline(always)]
    pub fn is_p0_0(&self) -> bool {
        *self == FUNC_A::P0_0
    }
    ...
    pub fn is_i2c1_sda(&self) -> bool {
        *self == FUNC_A::I2C1_SDA
    }
    #[doc = "Checks if the value of the field is `U0_TXD`"]
    #[inline(always)]
    pub fn is_u0_txd(&self) -> bool {
        *self == FUNC_A::U0_TXD
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_0(self) -> &'a mut W {
        self.variant(FUNC_A::P0_0)
    }
    ...
    #[doc = "I2C1 data input/output(this pin does not use a specialized I2C pad)."]
    #[inline(always)]
    pub fn i2c1_sda(self) -> &'a mut W {
        self.variant(FUNC_A::I2C1_SDA)
    }
    #[doc = "Transmitter output for UART0."]
    #[inline(always)]
    pub fn u0_txd(self) -> &'a mut W {
        self.variant(FUNC_A::U0_TXD)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[0\\]"]
    #[inline(always)]
