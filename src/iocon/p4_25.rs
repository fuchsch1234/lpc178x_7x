#[doc = "Reader of register P4_25"]
pub type R = crate::R<u32, super::P4_25>;
#[doc = "Writer for register P4_25"]
pub type W = crate::W<u32, super::P4_25>;
#[doc = "Register P4_25 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_25 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[25\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_25 = 0,
    #[doc = "1: LOW active Write Enable signal."]
    EMC_WE = 1,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P4_25`"]
    #[inline(always)]
    pub fn is_p4_25(&self) -> bool {
        *self == FUNC_A::P4_25
    }
    #[doc = "Checks if the value of the field is `EMC_WE`"]
    #[inline(always)]
    pub fn is_emc_we(&self) -> bool {
        *self == FUNC_A::EMC_WE
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_25(self) -> &'a mut W {
        self.variant(FUNC_A::P4_25)
    }
    #[doc = "LOW active Write Enable signal."]
    #[inline(always)]
    pub fn emc_we(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_WE)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[25\\]"]
    #[inline(always)]
