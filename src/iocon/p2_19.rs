#[doc = "Reader of register P2_19"]
pub type R = crate::R<u32, super::P2_19>;
#[doc = "Writer for register P2_19"]
pub type W = crate::W<u32, super::P2_19>;
#[doc = "Register P2_19 `reset()`'s with value 0x01b0"]
impl crate::ResetValue for super::P2_19 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[19\\]\n\nValue on reset: 0"]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_19),
            1 => Val(FUNC_A::EMC_CLK_1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_19`"]
    #[inline(always)]
    pub fn is_p2_19(&self) -> bool {
        *self == FUNC_A::P2_19
    }
    #[doc = "Checks if the value of the field is `EMC_CLK_1`"]
    #[inline(always)]
    pub fn is_emc_clk_1(&self) -> bool {
        *self == FUNC_A::EMC_CLK_1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_19(self) -> &'a mut W {
        self.variant(FUNC_A::P2_19)
    }
    #[doc = "SDRAM clock 1."]
    #[inline(always)]
    pub fn emc_clk_1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CLK_1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[19\\]"]
    #[inline(always)]
