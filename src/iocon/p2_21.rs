#[doc = "Reader of register P2_21"]
pub type R = crate::R<u32, super::P2_21>;
#[doc = "Writer for register P2_21"]
pub type W = crate::W<u32, super::P2_21>;
#[doc = "Register P2_21 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_21 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[21\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_21 = 0,
    #[doc = "1: SDRAM chip select 1."]
    EMC_DYCS1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_21),
            1 => Val(FUNC_A::EMC_DYCS1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_21`"]
    #[inline(always)]
    pub fn is_p2_21(&self) -> bool {
        *self == FUNC_A::P2_21
    }
    #[doc = "Checks if the value of the field is `EMC_DYCS1`"]
    #[inline(always)]
    pub fn is_emc_dycs1(&self) -> bool {
        *self == FUNC_A::EMC_DYCS1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_21(self) -> &'a mut W {
        self.variant(FUNC_A::P2_21)
    }
    #[doc = "SDRAM chip select 1."]
    #[inline(always)]
    pub fn emc_dycs1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DYCS1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[21\\]"]
    #[inline(always)]
