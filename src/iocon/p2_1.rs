#[doc = "Reader of register P2_1"]
pub type R = crate::R<u32, super::P2_1>;
#[doc = "Writer for register P2_1"]
pub type W = crate::W<u32, super::P2_1>;
#[doc = "Register P2_1 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[1\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_1 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 2                                             output."]
    PWM1_2 = 1,
    #[doc = "2: Receiver input for UART1."]
    U1_RXD = 2,
    #[doc = "7: Line end signal."]
    LCD_LE = 7,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P2_1`"]
    #[inline(always)]
    pub fn is_p2_1(&self) -> bool {
        *self == FUNC_A::P2_1
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_LE`"]
    #[inline(always)]
    pub fn is_lcd_le(&self) -> bool {
        *self == FUNC_A::LCD_LE
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_1(self) -> &'a mut W {
        self.variant(FUNC_A::P2_1)
    }
    ...
    #[doc = "Line end signal."]
    #[inline(always)]
    pub fn lcd_le(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_LE)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[1\\]"]
    #[inline(always)]
