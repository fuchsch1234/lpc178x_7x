#[doc = "Reader of register P2_4"]
pub type R = crate::R<u32, super::P2_4>;
#[doc = "Writer for register P2_4"]
pub type W = crate::W<u32, super::P2_4>;
#[doc = "Register P2_4 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[4\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_4 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 5                                             output."]
    PWM1_5 = 1,
    #[doc = "2: Data Set Ready input for UART1."]
    U1_DSR = 2,
    #[doc = "3: Match output for Timer 2, channel 1."]
    T2_MAT1 = 3,
    #[doc = "5: Trace data, bit 1."]
    TRACEDATA_1 = 5,
    #[doc = "7: STN AC bias drive or TFT data enable                                             output."]
    LCD_ENAB_M = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNC_A::PWM1_5),
            2 => Val(FUNC_A::U1_DSR),
            3 => Val(FUNC_A::T2_MAT1),
            5 => Val(FUNC_A::TRACEDATA_1),
            7 => Val(FUNC_A::LCD_ENAB_M),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_4`"]
    #[inline(always)]
    pub fn is_p2_4(&self) -> bool {
        *self == FUNC_A::P2_4
    }
    #[doc = "Checks if the value of the field is `PWM1_5`"]
    #[inline(always)]
    pub fn is_pwm1_5(&self) -> bool {
        *self == FUNC_A::PWM1_5
    }
    #[doc = "Checks if the value of the field is `U1_DSR`"]
    #[inline(always)]
    pub fn is_u1_dsr(&self) -> bool {
        *self == FUNC_A::U1_DSR
    }
    ...
    #[doc = "Checks if the value of the field is `TRACEDATA_1`"]
    #[inline(always)]
    pub fn is_tracedata_1(&self) -> bool {
        *self == FUNC_A::TRACEDATA_1
    }
    #[doc = "Checks if the value of the field is `LCD_ENAB_M`"]
    #[inline(always)]
    pub fn is_lcd_enab_m(&self) -> bool {
        *self == FUNC_A::LCD_ENAB_M
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_4(self) -> &'a mut W {
        self.variant(FUNC_A::P2_4)
    }
    #[doc = "Pulse Width Modulator 1, channel 5 output."]
    #[inline(always)]
    pub fn pwm1_5(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_5)
    }
    #[doc = "Data Set Ready input for UART1."]
    #[inline(always)]
    pub fn u1_dsr(self) -> &'a mut W {
        self.variant(FUNC_A::U1_DSR)
    }
    ...
    #[doc = "Trace data, bit 1."]
    #[inline(always)]
    pub fn tracedata_1(self) -> &'a mut W {
        self.variant(FUNC_A::TRACEDATA_1)
    }
    #[doc = "STN AC bias drive or TFT data enable output."]
    #[inline(always)]
    pub fn lcd_enab_m(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_ENAB_M)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[4\\]"]
    #[inline(always)]
