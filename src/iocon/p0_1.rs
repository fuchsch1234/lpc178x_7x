#[doc = "Reader of register P0_1"]
pub type R = crate::R<u32, super::P0_1>;
#[doc = "Writer for register P0_1"]
pub type W = crate::W<u32, super::P0_1>;
#[doc = "Register P0_1 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_1 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P0_1`"]
    #[inline(always)]
    pub fn is_p0_1(&self) -> bool {
        *self == FUNC_A::P0_1
    }
    ...
    #[doc = "Checks if the value of the field is `U0_RXD`"]
    #[inline(always)]
    pub fn is_u0_rxd(&self) -> bool {
        *self == FUNC_A::U0_RXD
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_1(self) -> &'a mut W {
        self.variant(FUNC_A::P0_1)
    }
    ...
    #[doc = "Receiver input for UART0."]
    #[inline(always)]
    pub fn u0_rxd(self) -> &'a mut W {
        self.variant(FUNC_A::U0_RXD)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[1\\]"]
    #[inline(always)]
