#[doc = "Reader of register P1_9"]
pub type R = crate::R<u32, super::P1_9>;
#[doc = "Writer for register P1_9"]
pub type W = crate::W<u32, super::P1_9>;
#[doc = "Register P1_9 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_9 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[9\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_9 = 0,
    #[doc = "1: Ethernet receive data 0 (RMII/MII                                             interface)."]
    ENET_RXD0 = 1,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_9),
            1 => Val(FUNC_A::ENET_RXD0),
            3 => Val(FUNC_A::T3_MAT0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_9`"]
    #[inline(always)]
    pub fn is_p1_9(&self) -> bool {
        *self == FUNC_A::P1_9
    }
    #[doc = "Checks if the value of the field is `ENET_RXD0`"]
    #[inline(always)]
    pub fn is_enet_rxd0(&self) -> bool {
        *self == FUNC_A::ENET_RXD0
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_9(self) -> &'a mut W {
        self.variant(FUNC_A::P1_9)
    }
    #[doc = "Ethernet receive data 0 (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_rxd0(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RXD0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[9\\]"]
    #[inline(always)]
