#[doc = "Reader of register P1_26"]
pub type R = crate::R<u32, super::P1_26>;
#[doc = "Writer for register P1_26"]
pub type W = crate::W<u32, super::P1_26>;
#[doc = "Register P1_26 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_26 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[26\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_26 = 0,
    #[doc = "1: USB port 1 Bus Suspend status (OTG                                             transceiver)."]
    USB_SSPND1 = 1,
    #[doc = "2: Pulse Width Modulator 1, channel 6                                             output."]
    PWM1_6 = 2,
    #[doc = "3: Capture input for Timer 0, channel 0."]
    T0_CAP0 = 3,
    #[doc = "4: Motor control PWM channel 1, output                                             B."]
    MC_1B = 4,
    #[doc = "5: Slave Select for SSP1."]
    SSP1_SSEL = 5,
    #[doc = "6: LCD data."]
    LCD_VD_12 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_26`"]
    #[inline(always)]
    pub fn is_p1_26(&self) -> bool {
        *self == FUNC_A::P1_26
    }
    #[doc = "Checks if the value of the field is `USB_SSPND1`"]
    #[inline(always)]
    pub fn is_usb_sspnd1(&self) -> bool {
        *self == FUNC_A::USB_SSPND1
    }
    #[doc = "Checks if the value of the field is `PWM1_6`"]
    #[inline(always)]
    pub fn is_pwm1_6(&self) -> bool {
        *self == FUNC_A::PWM1_6
    }
    #[doc = "Checks if the value of the field is `T0_CAP0`"]
    #[inline(always)]
    pub fn is_t0_cap0(&self) -> bool {
        *self == FUNC_A::T0_CAP0
    }
    #[doc = "Checks if the value of the field is `MC_1B`"]
    #[inline(always)]
    pub fn is_mc_1b(&self) -> bool {
        *self == FUNC_A::MC_1B
    }
    #[doc = "Checks if the value of the field is `SSP1_SSEL`"]
    #[inline(always)]
    pub fn is_ssp1_ssel(&self) -> bool {
        *self == FUNC_A::SSP1_SSEL
    }
    #[doc = "Checks if the value of the field is `LCD_VD_12`"]
    #[inline(always)]
    pub fn is_lcd_vd_12(&self) -> bool {
        *self == FUNC_A::LCD_VD_12
    }
    #[doc = "Checks if the value of the field is `LCD_VD_20`"]
    #[inline(always)]
    pub fn is_lcd_vd_20(&self) -> bool {
        *self == FUNC_A::LCD_VD_20
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_26(self) -> &'a mut W {
        self.variant(FUNC_A::P1_26)
    }
    #[doc = "USB port 1 Bus Suspend status (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_sspnd1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_SSPND1)
    }
    #[doc = "Pulse Width Modulator 1, channel 6 output."]
    #[inline(always)]
    pub fn pwm1_6(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_6)
    }
    #[doc = "Capture input for Timer 0, channel 0."]
    #[inline(always)]
    pub fn t0_cap0(self) -> &'a mut W {
        self.variant(FUNC_A::T0_CAP0)
    }
    #[doc = "Motor control PWM channel 1, output B."]
    #[inline(always)]
    pub fn mc_1b(self) -> &'a mut W {
        self.variant(FUNC_A::MC_1B)
    }
    #[doc = "Slave Select for SSP1."]
    #[inline(always)]
    pub fn ssp1_ssel(self) -> &'a mut W {
        self.variant(FUNC_A::SSP1_SSEL)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_12(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_12)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_20(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_20)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[26\\]"]
    #[inline(always)]
