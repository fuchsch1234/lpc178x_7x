#[doc = "Reader of register P1_4"]
pub type R = crate::R<u32, super::P1_4>;
#[doc = "Writer for register P1_4"]
pub type W = crate::W<u32, super::P1_4>;
#[doc = "Register P1_4 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[4\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_4 = 0,
    #[doc = "1: Ethernet transmit data enable (RMII/MII                                             interface)."]
    ENET_TX_EN = 1,
    #[doc = "3: Match output for Timer 3, channel 2."]
    T3_MAT2 = 3,
    #[doc = "4: Master In Slave Out for SSP2."]
    SSP2_MISO = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_4),
            1 => Val(FUNC_A::ENET_TX_EN),
            3 => Val(FUNC_A::T3_MAT2),
            4 => Val(FUNC_A::SSP2_MISO),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_4`"]
    #[inline(always)]
    pub fn is_p1_4(&self) -> bool {
        *self == FUNC_A::P1_4
    }
    #[doc = "Checks if the value of the field is `ENET_TX_EN`"]
    #[inline(always)]
    pub fn is_enet_tx_en(&self) -> bool {
        *self == FUNC_A::ENET_TX_EN
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_4(self) -> &'a mut W {
        self.variant(FUNC_A::P1_4)
    }
    #[doc = "Ethernet transmit data enable (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_tx_en(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TX_EN)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[4\\]"]
    #[inline(always)]
