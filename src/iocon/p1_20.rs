#[doc = "Reader of register P1_20"]
pub type R = crate::R<u32, super::P1_20>;
#[doc = "Writer for register P1_20"]
pub type W = crate::W<u32, super::P1_20>;
#[doc = "Register P1_20 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_20 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[20\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_20 = 0,
    #[doc = "1: D+ transmit data for USB port 1 (OTG                                             transceiver)."]
    USB_TX_DP1 = 1,
    #[doc = "2: Pulse Width Modulator 1, channel 2                                             output."]
    PWM1_2 = 2,
    #[doc = "3: Quadrature Encoder Interface PHA                                             input."]
    QEI_PHA = 3,
    #[doc = "4: Motor control PWM channel 0 feedback                                             input."]
    MC_FB0 = 4,
    #[doc = "5: Serial clock for SSP0."]
    SSP0_SCK = 5,
    #[doc = "6: LCD data."]
    LCD_VD_6 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_20`"]
    #[inline(always)]
    pub fn is_p1_20(&self) -> bool {
        *self == FUNC_A::P1_20
    }
    #[doc = "Checks if the value of the field is `USB_TX_DP1`"]
    #[inline(always)]
    pub fn is_usb_tx_dp1(&self) -> bool {
        *self == FUNC_A::USB_TX_DP1
    }
    ...
    #[doc = "Checks if the value of the field is `QEI_PHA`"]
    #[inline(always)]
    pub fn is_qei_pha(&self) -> bool {
        *self == FUNC_A::QEI_PHA
    }
    #[doc = "Checks if the value of the field is `MC_FB0`"]
    #[inline(always)]
    pub fn is_mc_fb0(&self) -> bool {
        *self == FUNC_A::MC_FB0
    }
    #[doc = "Checks if the value of the field is `SSP0_SCK`"]
    #[inline(always)]
    pub fn is_ssp0_sck(&self) -> bool {
        *self == FUNC_A::SSP0_SCK
    }
    #[doc = "Checks if the value of the field is `LCD_VD_6`"]
    #[inline(always)]
    pub fn is_lcd_vd_6(&self) -> bool {
        *self == FUNC_A::LCD_VD_6
    }
    #[doc = "Checks if the value of the field is `LCD_VD_10`"]
    #[inline(always)]
    pub fn is_lcd_vd_10(&self) -> bool {
        *self == FUNC_A::LCD_VD_10
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_20(self) -> &'a mut W {
        self.variant(FUNC_A::P1_20)
    }
    #[doc = "D+ transmit data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_tx_dp1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_TX_DP1)
    }
    #[doc = "Pulse Width Modulator 1, channel 2 output."]
    #[inline(always)]
    pub fn pwm1_2(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_2)
    }
    #[doc = "Quadrature Encoder Interface PHA input."]
    #[inline(always)]
    pub fn qei_pha(self) -> &'a mut W {
        self.variant(FUNC_A::QEI_PHA)
    }
    #[doc = "Motor control PWM channel 0 feedback input."]
    #[inline(always)]
    pub fn mc_fb0(self) -> &'a mut W {
        self.variant(FUNC_A::MC_FB0)
    }
    #[doc = "Serial clock for SSP0."]
    #[inline(always)]
    pub fn ssp0_sck(self) -> &'a mut W {
        self.variant(FUNC_A::SSP0_SCK)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_6(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_6)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_10(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_10)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[20\\]"]
    #[inline(always)]
