#[doc = "Reader of register P3_31"]
pub type R = crate::R<u32, super::P3_31>;
#[doc = "Writer for register P3_31"]
pub type W = crate::W<u32, super::P3_31>;
#[doc = "Register P3_31 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_31 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[31\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_31 = 0,
    #[doc = "1: External memory data line 31."]
    EMC_D_31 = 1,
    #[doc = "3: Match output for Timer 1, channel 2."]
    T1_MAT2 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_31),
            1 => Val(FUNC_A::EMC_D_31),
            3 => Val(FUNC_A::T1_MAT2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_31`"]
    #[inline(always)]
    pub fn is_p3_31(&self) -> bool {
        *self == FUNC_A::P3_31
    }
    #[doc = "Checks if the value of the field is `EMC_D_31`"]
    #[inline(always)]
    pub fn is_emc_d_31(&self) -> bool {
        *self == FUNC_A::EMC_D_31
    }
    #[doc = "Checks if the value of the field is `T1_MAT2`"]
    #[inline(always)]
    pub fn is_t1_mat2(&self) -> bool {
        *self == FUNC_A::T1_MAT2
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_31(self) -> &'a mut W {
        self.variant(FUNC_A::P3_31)
    }
    #[doc = "External memory data line 31."]
    #[inline(always)]
    pub fn emc_d_31(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_31)
    }
    #[doc = "Match output for Timer 1, channel 2."]
    #[inline(always)]
    pub fn t1_mat2(self) -> &'a mut W {
        self.variant(FUNC_A::T1_MAT2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[31\\]"]
    #[inline(always)]
