#[doc = "Reader of register P1_7"]
pub type R = crate::R<u32, super::P1_7>;
#[doc = "Writer for register P1_7"]
pub type W = crate::W<u32, super::P1_7>;
#[doc = "Register P1_7 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_7 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[7\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_7 = 0,
    #[doc = "1: Ethernet Collision detect (MII                                             interface)."]
    ENET_COL = 1,
    #[doc = "2: Data line 1 for SD card interface."]
    SD_DAT_1 = 2,
    #[doc = "3: Pulse Width Modulator 0, output 5."]
    PWM0_5 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_7),
            1 => Val(FUNC_A::ENET_COL),
            2 => Val(FUNC_A::SD_DAT_1),
            3 => Val(FUNC_A::PWM0_5),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_7`"]
    #[inline(always)]
    pub fn is_p1_7(&self) -> bool {
        *self == FUNC_A::P1_7
    }
    #[doc = "Checks if the value of the field is `ENET_COL`"]
    #[inline(always)]
    pub fn is_enet_col(&self) -> bool {
        *self == FUNC_A::ENET_COL
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_7(self) -> &'a mut W {
        self.variant(FUNC_A::P1_7)
    }
    #[doc = "Ethernet Collision detect (MII interface)."]
    #[inline(always)]
    pub fn enet_col(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_COL)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[7\\]"]
    #[inline(always)]
