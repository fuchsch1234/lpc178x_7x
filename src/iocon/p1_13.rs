#[doc = "Reader of register P1_13"]
pub type R = crate::R<u32, super::P1_13>;
#[doc = "Writer for register P1_13"]
pub type W = crate::W<u32, super::P1_13>;
#[doc = "Register P1_13 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_13 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[13\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_13 = 0,
    #[doc = "1: Ethernet Receive Data Valid (MII                                             interface)."]
    ENET_RX_DV = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_13),
            1 => Val(FUNC_A::ENET_RX_DV),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_13`"]
    #[inline(always)]
    pub fn is_p1_13(&self) -> bool {
        *self == FUNC_A::P1_13
    }
    #[doc = "Checks if the value of the field is `ENET_RX_DV`"]
    #[inline(always)]
    pub fn is_enet_rx_dv(&self) -> bool {
        *self == FUNC_A::ENET_RX_DV
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_13(self) -> &'a mut W {
        self.variant(FUNC_A::P1_13)
    }
    #[doc = "Ethernet Receive Data Valid (MII interface)."]
    #[inline(always)]
    pub fn enet_rx_dv(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RX_DV)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[13\\]"]
    #[inline(always)]
