#[doc = "Reader of register P0_21"]
pub type R = crate::R<u32, super::P0_21>;
#[doc = "Writer for register P0_21"]
pub type W = crate::W<u32, super::P0_21>;
#[doc = "Register P0_21 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_21 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[21\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_21 = 0,
    #[doc = "1: Ring Indicator input for UART1."]
    U1_RI = 1,
    #[doc = "2: Power Supply Enable for external SD card power                                             supply."]
    SD_PWR = 2,
    #[doc = "3: RS-485/EIA-485 output enable signal for                                             UART4."]
    U4_OE = 3,
    #[doc = "4: CAN1 receiver input."]
    CAN_RD1 = 4,
    #[doc = "5: USART 4 clock input or output in synchronous                                             mode."]
    U4_SCLK = 5,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            2 => Val(FUNC_A::SD_PWR),
            3 => Val(FUNC_A::U4_OE),
            4 => Val(FUNC_A::CAN_RD1),
            5 => Val(FUNC_A::U4_SCLK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_21`"]
    #[inline(always)]
    pub fn is_p0_21(&self) -> bool {
        *self == FUNC_A::P0_21
    }
    #[doc = "Checks if the value of the field is `U1_RI`"]
    #[inline(always)]
    pub fn is_u1_ri(&self) -> bool {
        *self == FUNC_A::U1_RI
    }
    #[doc = "Checks if the value of the field is `SD_PWR`"]
    #[inline(always)]
    pub fn is_sd_pwr(&self) -> bool {
        *self == FUNC_A::SD_PWR
    }
    #[doc = "Checks if the value of the field is `U4_OE`"]
    #[inline(always)]
    pub fn is_u4_oe(&self) -> bool {
        *self == FUNC_A::U4_OE
    }
    #[doc = "Checks if the value of the field is `CAN_RD1`"]
    #[inline(always)]
    pub fn is_can_rd1(&self) -> bool {
        *self == FUNC_A::CAN_RD1
    }
    #[doc = "Checks if the value of the field is `U4_SCLK`"]
    #[inline(always)]
    pub fn is_u4_sclk(&self) -> bool {
        *self == FUNC_A::U4_SCLK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_21(self) -> &'a mut W {
        self.variant(FUNC_A::P0_21)
    }
    #[doc = "Ring Indicator input for UART1."]
    #[inline(always)]
    pub fn u1_ri(self) -> &'a mut W {
        self.variant(FUNC_A::U1_RI)
    }
    #[doc = "Power Supply Enable for external SD card power supply."]
    #[inline(always)]
    pub fn sd_pwr(self) -> &'a mut W {
        self.variant(FUNC_A::SD_PWR)
    }
    #[doc = "RS-485/EIA-485 output enable signal for UART4."]
    #[inline(always)]
    pub fn u4_oe(self) -> &'a mut W {
        self.variant(FUNC_A::U4_OE)
    }
    #[doc = "CAN1 receiver input."]
    #[inline(always)]
    pub fn can_rd1(self) -> &'a mut W {
        self.variant(FUNC_A::CAN_RD1)
    }
    #[doc = "USART 4 clock input or output in synchronous mode."]
    #[inline(always)]
    pub fn u4_sclk(self) -> &'a mut W {
        self.variant(FUNC_A::U4_SCLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[21\\]"]
    #[inline(always)]
