#[doc = "Reader of register P1_22"]
pub type R = crate::R<u32, super::P1_22>;
#[doc = "Writer for register P1_22"]
pub type W = crate::W<u32, super::P1_22>;
#[doc = "Register P1_22 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_22 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[22\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_22 = 0,
    #[doc = "1: Differential receive data for USB port 1 (OTG                                             transceiver)."]
    USB_RCV1 = 1,
    #[doc = "2: Power Status for USB port 1 (host power                                             switch)."]
    USB_PWRD1 = 2,
    #[doc = "3: Match output for Timer 1, channel 0."]
    T1_MAT0 = 3,
    #[doc = "4: Motor control PWM channel 0, output                                             B."]
    MC_0B = 4,
    #[doc = "5: Master Out Slave In for SSP1."]
    SSP1_MOSI = 5,
    #[doc = "6: LCD data."]
    LCD_VD_8 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_22`"]
    #[inline(always)]
    pub fn is_p1_22(&self) -> bool {
        *self == FUNC_A::P1_22
    }
    #[doc = "Checks if the value of the field is `USB_RCV1`"]
    #[inline(always)]
    pub fn is_usb_rcv1(&self) -> bool {
        *self == FUNC_A::USB_RCV1
    }
    #[doc = "Checks if the value of the field is `USB_PWRD1`"]
    #[inline(always)]
    pub fn is_usb_pwrd1(&self) -> bool {
        *self == FUNC_A::USB_PWRD1
    }
    #[doc = "Checks if the value of the field is `T1_MAT0`"]
    #[inline(always)]
    pub fn is_t1_mat0(&self) -> bool {
        *self == FUNC_A::T1_MAT0
    }
    #[doc = "Checks if the value of the field is `MC_0B`"]
    #[inline(always)]
    pub fn is_mc_0b(&self) -> bool {
        *self == FUNC_A::MC_0B
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_22(self) -> &'a mut W {
        self.variant(FUNC_A::P1_22)
    }
    #[doc = "Differential receive data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_rcv1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_RCV1)
    }
    #[doc = "Power Status for USB port 1 (host power switch)."]
    #[inline(always)]
    pub fn usb_pwrd1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_PWRD1)
    }
    #[doc = "Match output for Timer 1, channel 0."]
    #[inline(always)]
    pub fn t1_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::T1_MAT0)
    }
    #[doc = "Motor control PWM channel 0, output B."]
    #[inline(always)]
    pub fn mc_0b(self) -> &'a mut W {
        self.variant(FUNC_A::MC_0B)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[22\\]"]
    #[inline(always)]
