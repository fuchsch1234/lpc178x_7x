#[doc = "Reader of register P1_25"]
pub type R = crate::R<u32, super::P1_25>;
#[doc = "Writer for register P1_25"]
pub type W = crate::W<u32, super::P1_25>;
#[doc = "Register P1_25 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_25 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_25`"]
    #[inline(always)]
    pub fn is_p1_25(&self) -> bool {
        *self == FUNC_A::P1_25
    }
    #[doc = "Checks if the value of the field is `USB_LS1`"]
    #[inline(always)]
    pub fn is_usb_ls1(&self) -> bool {
        *self == FUNC_A::USB_LS1
    }
    #[doc = "Checks if the value of the field is `USB_HSTEN1`"]
    #[inline(always)]
    pub fn is_usb_hsten1(&self) -> bool {
        *self == FUNC_A::USB_HSTEN1
    }
    #[doc = "Checks if the value of the field is `T1_MAT1`"]
    #[inline(always)]
    pub fn is_t1_mat1(&self) -> bool {
        *self == FUNC_A::T1_MAT1
    }
    #[doc = "Checks if the value of the field is `MC_1A`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_25(self) -> &'a mut W {
        self.variant(FUNC_A::P1_25)
    }
    #[doc = "Low Speed status for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_ls1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_LS1)
    }
    #[doc = "Host Enabled status for USB port 1."]
    #[inline(always)]
    pub fn usb_hsten1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_HSTEN1)
    }
    #[doc = "Match output for Timer 1, channel 1."]
    #[inline(always)]
    pub fn t1_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::T1_MAT1)
    }
    #[doc = "Motor control PWM channel 1, output A."]
    #[inline(always)]
    pub fn mc_1a(self) -> &'a mut W {
        self.variant(FUNC_A::MC_1A)
    }
