#[doc = "Reader of register P2_5"]
pub type R = crate::R<u32, super::P2_5>;
#[doc = "Writer for register P2_5"]
pub type W = crate::W<u32, super::P2_5>;
#[doc = "Register P2_5 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_5 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[5\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_5 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 6                                             output."]
    PWM1_6 = 1,
    #[doc = "2: Data Terminal Ready output for UART1. Can also be                                             configured to be an RS-485/EIA-485 output enable signal                                             for UART1."]
    U1_DTR = 2,
    #[doc = "3: Match output for Timer 2, channel 0."]
    T2_MAT0 = 3,
    #[doc = "5: Trace data, bit 0."]
    TRACEDATA_0 = 5,
    #[doc = "7: Line synchronization pulse (STN). Horizontal                                             synchronization pulse (TFT)."]
    LCD_LP = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNC_A::PWM1_6),
            2 => Val(FUNC_A::U1_DTR),
            3 => Val(FUNC_A::T2_MAT0),
            5 => Val(FUNC_A::TRACEDATA_0),
            7 => Val(FUNC_A::LCD_LP),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_5`"]
    #[inline(always)]
    pub fn is_p2_5(&self) -> bool {
        *self == FUNC_A::P2_5
    }
    ...
    #[doc = "Checks if the value of the field is `U1_DTR`"]
    #[inline(always)]
    pub fn is_u1_dtr(&self) -> bool {
        *self == FUNC_A::U1_DTR
    }
    #[doc = "Checks if the value of the field is `T2_MAT0`"]
    #[inline(always)]
    pub fn is_t2_mat0(&self) -> bool {
        *self == FUNC_A::T2_MAT0
    }
    #[doc = "Checks if the value of the field is `TRACEDATA_0`"]
    #[inline(always)]
    pub fn is_tracedata_0(&self) -> bool {
        *self == FUNC_A::TRACEDATA_0
    }
    #[doc = "Checks if the value of the field is `LCD_LP`"]
    #[inline(always)]
    pub fn is_lcd_lp(&self) -> bool {
        *self == FUNC_A::LCD_LP
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_5(self) -> &'a mut W {
        self.variant(FUNC_A::P2_5)
    }
    ...
    #[doc = "Data Terminal Ready output for UART1. Can also be configured to be an RS-485/EIA-485 output enable signal for UART1."]
    #[inline(always)]
    pub fn u1_dtr(self) -> &'a mut W {
        self.variant(FUNC_A::U1_DTR)
    }
    #[doc = "Match output for Timer 2, channel 0."]
    #[inline(always)]
    pub fn t2_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::T2_MAT0)
    }
    #[doc = "Trace data, bit 0."]
    #[inline(always)]
    pub fn tracedata_0(self) -> &'a mut W {
        self.variant(FUNC_A::TRACEDATA_0)
    }
    #[doc = "Line synchronization pulse (STN). Horizontal synchronization pulse (TFT)."]
    #[inline(always)]
    pub fn lcd_lp(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_LP)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[5\\]"]
    #[inline(always)]
