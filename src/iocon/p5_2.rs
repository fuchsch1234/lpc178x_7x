#[doc = "Reader of register P5_2"]
pub type R = crate::R<u32, super::P5_2>;
#[doc = "Writer for register P5_2"]
pub type W = crate::W<u32, super::P5_2>;
#[doc = "Register P5_2 `reset()`'s with value 0x80"]
impl crate::ResetValue for super::P5_2 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNC_A::I2C0_SDA),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P5_2`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p5_2(self) -> &'a mut W {
        self.variant(FUNC_A::P5_2)
    }
