#[doc = "Reader of register P2_25"]
pub type R = crate::R<u32, super::P2_25>;
#[doc = "Writer for register P2_25"]
pub type W = crate::W<u32, super::P2_25>;
#[doc = "Register P2_25 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_25 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[25\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_25 = 0,
    #[doc = "1: SDRAM clock enable 1."]
    EMC_CKE1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_25),
            1 => Val(FUNC_A::EMC_CKE1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_25`"]
    #[inline(always)]
    pub fn is_p2_25(&self) -> bool {
        *self == FUNC_A::P2_25
    }
    #[doc = "Checks if the value of the field is `EMC_CKE1`"]
    #[inline(always)]
    pub fn is_emc_cke1(&self) -> bool {
        *self == FUNC_A::EMC_CKE1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_25(self) -> &'a mut W {
        self.variant(FUNC_A::P2_25)
    }
    #[doc = "SDRAM clock enable 1."]
    #[inline(always)]
    pub fn emc_cke1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CKE1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[25\\]"]
    #[inline(always)]
