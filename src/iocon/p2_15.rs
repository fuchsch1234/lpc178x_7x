#[doc = "Reader of register P2_15"]
pub type R = crate::R<u32, super::P2_15>;
#[doc = "Writer for register P2_15"]
pub type W = crate::W<u32, super::P2_15>;
#[doc = "Register P2_15 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_15 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[15\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_15 = 0,
    #[doc = "1: LOW active Chip Select 3 signal."]
    EMC_CS3 = 1,
    #[doc = "2: I2C1 clock                                             input/output (this pin does not use a specialized I2C                                             pad)."]
    I2C1_SCL = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_15),
            1 => Val(FUNC_A::EMC_CS3),
            2 => Val(FUNC_A::I2C1_SCL),
            3 => Val(FUNC_A::T2_CAP1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_15`"]
    #[inline(always)]
    pub fn is_p2_15(&self) -> bool {
        *self == FUNC_A::P2_15
    }
    #[doc = "Checks if the value of the field is `EMC_CS3`"]
    #[inline(always)]
    pub fn is_emc_cs3(&self) -> bool {
        *self == FUNC_A::EMC_CS3
    }
    ...
    #[doc = "Checks if the value of the field is `T2_CAP1`"]
    #[inline(always)]
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_15(self) -> &'a mut W {
        self.variant(FUNC_A::P2_15)
    }
    #[doc = "LOW active Chip Select 3 signal."]
    #[inline(always)]
    pub fn emc_cs3(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CS3)
    }
    ...
    #[inline(always)]
    pub fn t2_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::T2_CAP1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[15\\]"]
    #[inline(always)]
