#[doc = "Reader of register P2_16"]
pub type R = crate::R<u32, super::P2_16>;
#[doc = "Writer for register P2_16"]
pub type W = crate::W<u32, super::P2_16>;
#[doc = "Register P2_16 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_16 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[16\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_16 = 0,
    #[doc = "1: LOW active SDRAM Column Address                                             Strobe."]
    EMC_CAS = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_16),
            1 => Val(FUNC_A::EMC_CAS),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_16`"]
    #[inline(always)]
    pub fn is_p2_16(&self) -> bool {
        *self == FUNC_A::P2_16
    }
    #[doc = "Checks if the value of the field is `EMC_CAS`"]
    #[inline(always)]
    pub fn is_emc_cas(&self) -> bool {
        *self == FUNC_A::EMC_CAS
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_16(self) -> &'a mut W {
        self.variant(FUNC_A::P2_16)
    }
    #[doc = "LOW active SDRAM Column Address Strobe."]
    #[inline(always)]
    pub fn emc_cas(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CAS)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[16\\]"]
    #[inline(always)]
