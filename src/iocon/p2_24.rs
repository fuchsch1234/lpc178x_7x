#[doc = "Reader of register P2_24"]
pub type R = crate::R<u32, super::P2_24>;
#[doc = "Writer for register P2_24"]
pub type W = crate::W<u32, super::P2_24>;
#[doc = "Register P2_24 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_24 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[24\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_24 = 0,
    #[doc = "1: SDRAM clock enable 0."]
    EMC_CKE0 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_24),
            1 => Val(FUNC_A::EMC_CKE0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_24`"]
    #[inline(always)]
    pub fn is_p2_24(&self) -> bool {
        *self == FUNC_A::P2_24
    }
    #[doc = "Checks if the value of the field is `EMC_CKE0`"]
    #[inline(always)]
    pub fn is_emc_cke0(&self) -> bool {
        *self == FUNC_A::EMC_CKE0
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_24(self) -> &'a mut W {
        self.variant(FUNC_A::P2_24)
    }
    #[doc = "SDRAM clock enable 0."]
    #[inline(always)]
    pub fn emc_cke0(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CKE0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[24\\]"]
    #[inline(always)]
