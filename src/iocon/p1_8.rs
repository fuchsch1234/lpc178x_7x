#[doc = "Reader of register P1_8"]
pub type R = crate::R<u32, super::P1_8>;
#[doc = "Writer for register P1_8"]
pub type W = crate::W<u32, super::P1_8>;
#[doc = "Register P1_8 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_8 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[8\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_8 = 0,
    #[doc = "1: Ethernet Carrier Sense (MII interface) or                                             Ethernet Carrier Sense/Data Valid (RMII                                             interface)."]
    ENET_CRS_CRS_DV = 1,
    #[doc = "3: Match output for Timer 3, channel 1."]
    T3_MAT1 = 3,
    #[doc = "4: Slave Select for SSP2."]
    SSP2_SSEL = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_8),
            1 => Val(FUNC_A::ENET_CRS_CRS_DV),
            3 => Val(FUNC_A::T3_MAT1),
            4 => Val(FUNC_A::SSP2_SSEL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_8`"]
    #[inline(always)]
    pub fn is_p1_8(&self) -> bool {
        *self == FUNC_A::P1_8
    }
    #[doc = "Checks if the value of the field is `ENET_CRS_CRS_DV`"]
    #[inline(always)]
    pub fn is_enet_crs_crs_dv(&self) -> bool {
        *self == FUNC_A::ENET_CRS_CRS_DV
    }
    #[doc = "Checks if the value of the field is `T3_MAT1`"]
    #[inline(always)]
    pub fn is_t3_mat1(&self) -> bool {
        *self == FUNC_A::T3_MAT1
    }
    #[doc = "Checks if the value of the field is `SSP2_SSEL`"]
    #[inline(always)]
    pub fn is_ssp2_ssel(&self) -> bool {
        *self == FUNC_A::SSP2_SSEL
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_8(self) -> &'a mut W {
        self.variant(FUNC_A::P1_8)
    }
    #[doc = "Ethernet Carrier Sense (MII interface) or Ethernet Carrier Sense/Data Valid (RMII interface)."]
    #[inline(always)]
    pub fn enet_crs_crs_dv(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_CRS_CRS_DV)
    }
    #[doc = "Match output for Timer 3, channel 1."]
    #[inline(always)]
    pub fn t3_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::T3_MAT1)
    }
    #[doc = "Slave Select for SSP2."]
    #[inline(always)]
    pub fn ssp2_ssel(self) -> &'a mut W {
        self.variant(FUNC_A::SSP2_SSEL)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[8\\]"]
    #[inline(always)]
