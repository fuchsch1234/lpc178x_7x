#[doc = "Reader of register P3_19"]
pub type R = crate::R<u32, super::P3_19>;
#[doc = "Writer for register P3_19"]
pub type W = crate::W<u32, super::P3_19>;
#[doc = "Register P3_19 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_19 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_19),
            1 => Val(FUNC_A::EMC_D_19),
            2 => Val(FUNC_A::PWM0_4),
            3 => Val(FUNC_A::U1_DCD),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_19`"]
    #[inline(always)]
    pub fn is_p3_19(&self) -> bool {
        *self == FUNC_A::P3_19
    }
    #[doc = "Checks if the value of the field is `EMC_D_19`"]
    #[inline(always)]
    pub fn is_emc_d_19(&self) -> bool {
        *self == FUNC_A::EMC_D_19
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_19(self) -> &'a mut W {
        self.variant(FUNC_A::P3_19)
    }
    #[doc = "External memory data line 19."]
    #[inline(always)]
    pub fn emc_d_19(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_19)
    }
