#[doc = "Reader of register P2_28"]
pub type R = crate::R<u32, super::P2_28>;
#[doc = "Writer for register P2_28"]
pub type W = crate::W<u32, super::P2_28>;
#[doc = "Register P2_28 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_28 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[28\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_28 = 0,
    #[doc = "1: Data mask 0 used with SDRAM and static                                             devices."]
    EMC_DQM0 = 1,
}
