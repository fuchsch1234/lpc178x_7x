#[doc = "Reader of register P4_11"]
pub type R = crate::R<u32, super::P4_11>;
#[doc = "Writer for register P4_11"]
pub type W = crate::W<u32, super::P4_11>;
#[doc = "Register P4_11 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_11 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[11\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_11 = 0,
    #[doc = "1: External memory address line 11."]
    EMC_A_11 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_11),
            1 => Val(FUNC_A::EMC_A_11),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_11`"]
    #[inline(always)]
    pub fn is_p4_11(&self) -> bool {
        *self == FUNC_A::P4_11
    }
    #[doc = "Checks if the value of the field is `EMC_A_11`"]
    #[inline(always)]
    pub fn is_emc_a_11(&self) -> bool {
        *self == FUNC_A::EMC_A_11
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_11(self) -> &'a mut W {
        self.variant(FUNC_A::P4_11)
    }
    #[doc = "External memory address line 11."]
    #[inline(always)]
    pub fn emc_a_11(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_11)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[11\\]"]
    #[inline(always)]
