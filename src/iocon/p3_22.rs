#[doc = "Reader of register P3_22"]
pub type R = crate::R<u32, super::P3_22>;
#[doc = "Writer for register P3_22"]
pub type W = crate::W<u32, super::P3_22>;
#[doc = "Register P3_22 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_22 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[22\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_22 = 0,
    #[doc = "1: External memory data line 22."]
    EMC_D_22 = 1,
    #[doc = "2: Capture input for PWM0, channel 0."]
    PWM0_CAP0 = 2,
    #[doc = "3: Ring Indicator input for UART1."]
    U1_RI = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_22),
            1 => Val(FUNC_A::EMC_D_22),
            2 => Val(FUNC_A::PWM0_CAP0),
            3 => Val(FUNC_A::U1_RI),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_22`"]
    #[inline(always)]
    pub fn is_p3_22(&self) -> bool {
        *self == FUNC_A::P3_22
    }
    #[doc = "Checks if the value of the field is `EMC_D_22`"]
    #[inline(always)]
    pub fn is_emc_d_22(&self) -> bool {
        *self == FUNC_A::EMC_D_22
    }
    #[doc = "Checks if the value of the field is `PWM0_CAP0`"]
    #[inline(always)]
    pub fn is_pwm0_cap0(&self) -> bool {
        *self == FUNC_A::PWM0_CAP0
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_22(self) -> &'a mut W {
        self.variant(FUNC_A::P3_22)
    }
    #[doc = "External memory data line 22."]
    #[inline(always)]
    pub fn emc_d_22(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_22)
    }
    #[doc = "Capture input for PWM0, channel 0."]
    #[inline(always)]
    pub fn pwm0_cap0(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_CAP0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[22\\]"]
    #[inline(always)]
