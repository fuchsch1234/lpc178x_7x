#[doc = "Reader of register P3_28"]
pub type R = crate::R<u32, super::P3_28>;
#[doc = "Writer for register P3_28"]
pub type W = crate::W<u32, super::P3_28>;
#[doc = "Register P3_28 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_28 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[28\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_28 = 0,
    #[doc = "1: External memory data line 28."]
    EMC_D_28 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 5."]
    PWM1_5 = 2,
    #[doc = "3: Capture input for Timer 1, channel 1."]
    T1_CAP1 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_28),
            1 => Val(FUNC_A::EMC_D_28),
            2 => Val(FUNC_A::PWM1_5),
            3 => Val(FUNC_A::T1_CAP1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_28`"]
    #[inline(always)]
    pub fn is_p3_28(&self) -> bool {
        *self == FUNC_A::P3_28
    }
    #[doc = "Checks if the value of the field is `EMC_D_28`"]
    #[inline(always)]
    pub fn is_emc_d_28(&self) -> bool {
        *self == FUNC_A::EMC_D_28
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_28(self) -> &'a mut W {
        self.variant(FUNC_A::P3_28)
    }
    #[doc = "External memory data line 28."]
    #[inline(always)]
    pub fn emc_d_28(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_28)
    }
    #[doc = "Pulse Width Modulator 1, output 5."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[28\\]"]
    #[inline(always)]
