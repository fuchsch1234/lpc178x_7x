#[doc = "Reader of register P3_20"]
pub type R = crate::R<u32, super::P3_20>;
#[doc = "Writer for register P3_20"]
pub type W = crate::W<u32, super::P3_20>;
#[doc = "Register P3_20 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_20 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[20\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_20 = 0,
    #[doc = "1: External memory data line 20."]
    EMC_D_20 = 1,
    #[doc = "2: Pulse Width Modulator 0, output 5."]
    PWM0_5 = 2,
    #[doc = "3: Data Set Ready input for UART1."]
    U1_DSR = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_20),
            1 => Val(FUNC_A::EMC_D_20),
            2 => Val(FUNC_A::PWM0_5),
            3 => Val(FUNC_A::U1_DSR),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_20`"]
    #[inline(always)]
    pub fn is_p3_20(&self) -> bool {
        *self == FUNC_A::P3_20
    }
    #[doc = "Checks if the value of the field is `EMC_D_20`"]
    #[inline(always)]
    pub fn is_emc_d_20(&self) -> bool {
        *self == FUNC_A::EMC_D_20
    }
    #[doc = "Checks if the value of the field is `PWM0_5`"]
    #[inline(always)]
    pub fn is_pwm0_5(&self) -> bool {
        *self == FUNC_A::PWM0_5
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_20(self) -> &'a mut W {
        self.variant(FUNC_A::P3_20)
    }
    #[doc = "External memory data line 20."]
    #[inline(always)]
    pub fn emc_d_20(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_20)
    }
    #[doc = "Pulse Width Modulator 0, output 5."]
    #[inline(always)]
    pub fn pwm0_5(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_5)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[20\\]"]
    #[inline(always)]
