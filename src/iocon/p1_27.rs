#[doc = "Reader of register P1_27"]
pub type R = crate::R<u32, super::P1_27>;
#[doc = "Writer for register P1_27"]
pub type W = crate::W<u32, super::P1_27>;
#[doc = "Register P1_27 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_27 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[27\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_27 = 0,
    #[doc = "1: USB port 1 OTG transceiver interrupt (OTG                                             transceiver)."]
    USB_INT1 = 1,
    #[doc = "2: USB port 1 Over-Current status."]
    USB_OVRCR1 = 2,
    #[doc = "3: Capture input for Timer 0, channel 1."]
    T0_CAP1 = 3,
    #[doc = "4: Selectable clock output."]
    CLKOUT = 4,
    #[doc = "6: LCD data."]
    LCD_VD_13 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_27),
            1 => Val(FUNC_A::USB_INT1),
            2 => Val(FUNC_A::USB_OVRCR1),
            3 => Val(FUNC_A::T0_CAP1),
            4 => Val(FUNC_A::CLKOUT),
            6 => Val(FUNC_A::LCD_VD_13),
            7 => Val(FUNC_A::LCD_VD_21),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `USB_INT1`"]
    #[inline(always)]
    pub fn is_usb_int1(&self) -> bool {
        *self == FUNC_A::USB_INT1
    }
    #[doc = "Checks if the value of the field is `USB_OVRCR1`"]
    #[inline(always)]
    pub fn is_usb_ovrcr1(&self) -> bool {
        *self == FUNC_A::USB_OVRCR1
    }
    #[doc = "Checks if the value of the field is `T0_CAP1`"]
    #[inline(always)]
    pub fn is_t0_cap1(&self) -> bool {
        *self == FUNC_A::T0_CAP1
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_VD_13`"]
    #[inline(always)]
    pub fn is_lcd_vd_13(&self) -> bool {
        *self == FUNC_A::LCD_VD_13
    }
    #[doc = "Checks if the value of the field is `LCD_VD_21`"]
    #[inline(always)]
    pub fn is_lcd_vd_21(&self) -> bool {
        *self == FUNC_A::LCD_VD_21
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn p1_27(self) -> &'a mut W {
        self.variant(FUNC_A::P1_27)
    }
    #[doc = "USB port 1 OTG transceiver interrupt (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_int1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_INT1)
    }
    #[doc = "USB port 1 Over-Current status."]
    #[inline(always)]
    pub fn usb_ovrcr1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_OVRCR1)
    }
    #[doc = "Capture input for Timer 0, channel 1."]
    #[inline(always)]
    pub fn t0_cap1(self) -> &'a mut W {
        self.variant(FUNC_A::T0_CAP1)
    }
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_13(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_13)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_21(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_21)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[27\\]"]
    #[inline(always)]
