#[doc = "Reader of register P4_30"]
pub type R = crate::R<u32, super::P4_30>;
#[doc = "Writer for register P4_30"]
pub type W = crate::W<u32, super::P4_30>;
#[doc = "Register P4_30 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_30 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[30\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_30 = 0,
    #[doc = "1: LOW active Chip Select 0 signal."]
    EMC_CS0 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_30),
            1 => Val(FUNC_A::EMC_CS0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_30`"]
    #[inline(always)]
    pub fn is_p4_30(&self) -> bool {
        *self == FUNC_A::P4_30
    }
    #[doc = "Checks if the value of the field is `EMC_CS0`"]
    #[inline(always)]
    pub fn is_emc_cs0(&self) -> bool {
        *self == FUNC_A::EMC_CS0
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_30(self) -> &'a mut W {
        self.variant(FUNC_A::P4_30)
    }
    #[doc = "LOW active Chip Select 0 signal."]
    #[inline(always)]
    pub fn emc_cs0(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CS0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[30\\]"]
    #[inline(always)]
