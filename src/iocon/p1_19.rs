#[doc = "Reader of register P1_19"]
pub type R = crate::R<u32, super::P1_19>;
#[doc = "Writer for register P1_19"]
pub type W = crate::W<u32, super::P1_19>;
#[doc = "Register P1_19 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_19 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[19\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_19 = 0,
    #[doc = "1: Transmit Enable signal for USB port 1 (OTG                                             transceiver)."]
    USB_TX_E1 = 1,
    #[doc = "2: Port Power enable signal for USB port                                             1."]
    USB_PPWR1 = 2,
    #[doc = "3: Capture input for Timer 1, channel 1."]
    T1_CAP1 = 3,
    #[doc = "4: Motor control PWM channel 0, output                                             A."]
    MC_0A = 4,
    #[doc = "5: Serial clock for SSP1."]
    SSP1_SCK = 5,
    #[doc = "6: RS-485/EIA-485 output enable signal for                                             UART2."]
    U2_OE = 6,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_19),
            1 => Val(FUNC_A::USB_TX_E1),
            2 => Val(FUNC_A::USB_PPWR1),
            3 => Val(FUNC_A::T1_CAP1),
            4 => Val(FUNC_A::MC_0A),
            5 => Val(FUNC_A::SSP1_SCK),
            6 => Val(FUNC_A::U2_OE),
            i => Res(i),
        }
    }
