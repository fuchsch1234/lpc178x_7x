#[doc = "Reader of register P1_0"]
pub type R = crate::R<u32, super::P1_0>;
#[doc = "Writer for register P1_0"]
pub type W = crate::W<u32, super::P1_0>;
#[doc = "Register P1_0 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[0\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_0 = 0,
    #[doc = "1: Ethernet transmit data 0 (RMII/MII                                             interface)."]
    ENET_TXD0 = 1,
    #[doc = "3: Capture input for Timer 3, channel 1."]
    T3_CAP1 = 3,
    #[doc = "4: Serial clock for SSP2."]
    SSP2_SCK = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_0),
            1 => Val(FUNC_A::ENET_TXD0),
            3 => Val(FUNC_A::T3_CAP1),
            4 => Val(FUNC_A::SSP2_SCK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_0`"]
    #[inline(always)]
    pub fn is_p1_0(&self) -> bool {
        *self == FUNC_A::P1_0
    }
    #[doc = "Checks if the value of the field is `ENET_TXD0`"]
    #[inline(always)]
    pub fn is_enet_txd0(&self) -> bool {
        *self == FUNC_A::ENET_TXD0
    }
    ...
    #[doc = "Checks if the value of the field is `SSP2_SCK`"]
    #[inline(always)]
    pub fn is_ssp2_sck(&self) -> bool {
        *self == FUNC_A::SSP2_SCK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_0(self) -> &'a mut W {
        self.variant(FUNC_A::P1_0)
    }
    #[doc = "Ethernet transmit data 0 (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_txd0(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TXD0)
    }
    ...
    #[doc = "Serial clock for SSP2."]
    #[inline(always)]
    pub fn ssp2_sck(self) -> &'a mut W {
        self.variant(FUNC_A::SSP2_SCK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[0\\]"]
    #[inline(always)]
