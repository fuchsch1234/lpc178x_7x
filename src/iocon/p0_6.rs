#[doc = "Reader of register P0_6"]
pub type R = crate::R<u32, super::P0_6>;
#[doc = "Writer for register P0_6"]
pub type W = crate::W<u32, super::P0_6>;
#[doc = "Register P0_6 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_6 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[6\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_6 = 0,
    #[doc = "1: I2S Receive data. It                                             is driven by the transmitter and read by the receiver.                                             Corresponds to the signal SD in the                                                   I2S-bus                                                 specification."]
    I2S_RX_SDA = 1,
    #[doc = "2: Slave Select for SSP1."]
    SSP1_SSEL = 2,
    #[doc = "3: Match output for Timer 2, channel 0."]
    T2_MAT0 = 3,
    #[doc = "4: Request to Send output for UART1. Can also be                                             configured to be an RS-485/EIA-485 output enable signal                                             for UART1."]
    U1_RTS = 4,
    #[doc = "7: LCD data."]
    LCD_VD_8 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_6),
            1 => Val(FUNC_A::I2S_RX_SDA),
            2 => Val(FUNC_A::SSP1_SSEL),
            3 => Val(FUNC_A::T2_MAT0),
            4 => Val(FUNC_A::U1_RTS),
            7 => Val(FUNC_A::LCD_VD_8),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_6`"]
    #[inline(always)]
    pub fn is_p0_6(&self) -> bool {
        *self == FUNC_A::P0_6
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_6(self) -> &'a mut W {
        self.variant(FUNC_A::P0_6)
    }
    #[doc = "I2S Receive data. It is driven by the transmitter and read by the receiver. Corresponds to the signal SD in the I2S-bus specification."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[6\\]"]
    #[inline(always)]
