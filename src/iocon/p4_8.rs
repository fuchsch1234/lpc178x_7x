#[doc = "Reader of register P4_8"]
pub type R = crate::R<u32, super::P4_8>;
#[doc = "Writer for register P4_8"]
pub type W = crate::W<u32, super::P4_8>;
#[doc = "Register P4_8 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_8 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[8\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_8 = 0,
    #[doc = "1: External memory address line 8."]
    EMC_A_8 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_8),
            1 => Val(FUNC_A::EMC_A_8),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_8`"]
    #[inline(always)]
    pub fn is_p4_8(&self) -> bool {
        *self == FUNC_A::P4_8
    }
    #[doc = "Checks if the value of the field is `EMC_A_8`"]
    #[inline(always)]
    pub fn is_emc_a_8(&self) -> bool {
        *self == FUNC_A::EMC_A_8
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_8(self) -> &'a mut W {
        self.variant(FUNC_A::P4_8)
    }
    #[doc = "External memory address line 8."]
    #[inline(always)]
    pub fn emc_a_8(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_8)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[8\\]"]
    #[inline(always)]
