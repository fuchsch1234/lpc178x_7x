#[doc = "Reader of register P1_17"]
pub type R = crate::R<u32, super::P1_17>;
#[doc = "Writer for register P1_17"]
pub type W = crate::W<u32, super::P1_17>;
#[doc = "Register P1_17 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_17 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_17),
            1 => Val(FUNC_A::ENET_MDIO),
            2 => Val(FUNC_A::I2S_RX_MCLK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_17`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `I2S_RX_MCLK`"]
    #[inline(always)]
    pub fn is_i2s_rx_mclk(&self) -> bool {
        *self == FUNC_A::I2S_RX_MCLK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_17(self) -> &'a mut W {
        self.variant(FUNC_A::P1_17)
    }
    ...
    #[inline(always)]
    pub fn i2s_rx_mclk(self) -> &'a mut W {
        self.variant(FUNC_A::I2S_RX_MCLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[17\\]"]
    #[inline(always)]
