#[doc = "Reader of register P1_21"]
pub type R = crate::R<u32, super::P1_21>;
#[doc = "Writer for register P1_21"]
pub type W = crate::W<u32, super::P1_21>;
#[doc = "Register P1_21 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_21 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[21\\]\n\nValue on reset: 0"]
...
pub enum FUNC_A {
    ...
    USB_TX_DM1 = 1,
    #[doc = "2: Pulse Width Modulator 1, channel 3                                             output."]
    PWM1_3 = 2,
    #[doc = "3: Slave Select for SSP0."]
    SSP0_SSEL = 3,
    #[doc = "4: Motor control PWM, active low fast                                             abort."]
    MC_ABORT = 4,
    #[doc = "6: LCD data."]
    LCD_VD_7 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_21),
            1 => Val(FUNC_A::USB_TX_DM1),
            2 => Val(FUNC_A::PWM1_3),
            3 => Val(FUNC_A::SSP0_SSEL),
            4 => Val(FUNC_A::MC_ABORT),
            6 => Val(FUNC_A::LCD_VD_7),
            7 => Val(FUNC_A::LCD_VD_11),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_21`"]
    #[inline(always)]
    pub fn is_p1_21(&self) -> bool {
        *self == FUNC_A::P1_21
    }
    #[doc = "Checks if the value of the field is `USB_TX_DM1`"]
    #[inline(always)]
    pub fn is_usb_tx_dm1(&self) -> bool {
        *self == FUNC_A::USB_TX_DM1
    }
    ...
    #[doc = "Checks if the value of the field is `SSP0_SSEL`"]
    #[inline(always)]
    pub fn is_ssp0_ssel(&self) -> bool {
        *self == FUNC_A::SSP0_SSEL
    }
    #[doc = "Checks if the value of the field is `MC_ABORT`"]
    #[inline(always)]
    pub fn is_mc_abort(&self) -> bool {
        *self == FUNC_A::MC_ABORT
    }
    #[doc = "Checks if the value of the field is `LCD_VD_7`"]
    #[inline(always)]
    pub fn is_lcd_vd_7(&self) -> bool {
        *self == FUNC_A::LCD_VD_7
    }
    #[doc = "Checks if the value of the field is `LCD_VD_11`"]
    #[inline(always)]
    pub fn is_lcd_vd_11(&self) -> bool {
        *self == FUNC_A::LCD_VD_11
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_21(self) -> &'a mut W {
        self.variant(FUNC_A::P1_21)
    }
    #[doc = "D- transmit data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_tx_dm1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_TX_DM1)
    }
    #[doc = "Pulse Width Modulator 1, channel 3 output."]
    #[inline(always)]
    pub fn pwm1_3(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_3)
    }
    #[doc = "Slave Select for SSP0."]
    #[inline(always)]
    pub fn ssp0_ssel(self) -> &'a mut W {
        self.variant(FUNC_A::SSP0_SSEL)
    }
    #[doc = "Motor control PWM, active low fast abort."]
    #[inline(always)]
    pub fn mc_abort(self) -> &'a mut W {
        self.variant(FUNC_A::MC_ABORT)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_7(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_7)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_11(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_11)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[21\\]"]
    #[inline(always)]
