#[doc = "Reader of register P1_2"]
pub type R = crate::R<u32, super::P1_2>;
#[doc = "Writer for register P1_2"]
pub type W = crate::W<u32, super::P1_2>;
#[doc = "Register P1_2 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_2 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[2\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_2 = 0,
    #[doc = "1: Ethernet transmit data 2 (MII                                             interface)."]
    ENET_TXD2 = 1,
    #[doc = "2: Clock output line for SD card                                             interface."]
    SD_CLK = 2,
    #[doc = "3: Pulse Width Modulator 0, output 1."]
    PWM0_1 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_2),
            1 => Val(FUNC_A::ENET_TXD2),
            2 => Val(FUNC_A::SD_CLK),
            3 => Val(FUNC_A::PWM0_1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_2`"]
    #[inline(always)]
    pub fn is_p1_2(&self) -> bool {
        *self == FUNC_A::P1_2
    }
    #[doc = "Checks if the value of the field is `ENET_TXD2`"]
    #[inline(always)]
    pub fn is_enet_txd2(&self) -> bool {
        *self == FUNC_A::ENET_TXD2
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_2(self) -> &'a mut W {
        self.variant(FUNC_A::P1_2)
    }
    #[doc = "Ethernet transmit data 2 (MII interface)."]
    #[inline(always)]
    pub fn enet_txd2(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TXD2)
    }
    ...
    #[doc = "Pulse Width Modulator 0, output 1."]
    #[inline(always)]
    pub fn pwm0_1(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[2\\]"]
    #[inline(always)]
