#[doc = "Reader of register P3_4"]
pub type R = crate::R<u32, super::P3_4>;
#[doc = "Writer for register P3_4"]
pub type W = crate::W<u32, super::P3_4>;
#[doc = "Register P3_4 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[4\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_4 = 0,
    #[doc = "1: External memory data line 4."]
    EMC_D_4 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_4),
            1 => Val(FUNC_A::EMC_D_4),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_4`"]
    #[inline(always)]
    pub fn is_p3_4(&self) -> bool {
        *self == FUNC_A::P3_4
    }
    #[doc = "Checks if the value of the field is `EMC_D_4`"]
    #[inline(always)]
    pub fn is_emc_d_4(&self) -> bool {
        *self == FUNC_A::EMC_D_4
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_4(self) -> &'a mut W {
        self.variant(FUNC_A::P3_4)
    }
    #[doc = "External memory data line 4."]
    #[inline(always)]
    pub fn emc_d_4(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_4)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[4\\]"]
    #[inline(always)]
