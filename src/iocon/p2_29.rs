#[doc = "Reader of register P2_29"]
pub type R = crate::R<u32, super::P2_29>;
#[doc = "Writer for register P2_29"]
pub type W = crate::W<u32, super::P2_29>;
#[doc = "Register P2_29 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_29 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[29\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_29 = 0,
    #[doc = "1: Data mask 1 used with SDRAM and static                                             devices."]
    EMC_DQM1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_29),
            1 => Val(FUNC_A::EMC_DQM1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_29`"]
    #[inline(always)]
    pub fn is_p2_29(&self) -> bool {
        *self == FUNC_A::P2_29
    }
    #[doc = "Checks if the value of the field is `EMC_DQM1`"]
    #[inline(always)]
    pub fn is_emc_dqm1(&self) -> bool {
        *self == FUNC_A::EMC_DQM1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_29(self) -> &'a mut W {
        self.variant(FUNC_A::P2_29)
    }
    #[doc = "Data mask 1 used with SDRAM and static devices."]
    #[inline(always)]
    pub fn emc_dqm1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_DQM1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[29\\]"]
    #[inline(always)]
