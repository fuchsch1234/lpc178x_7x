#[doc = "Reader of register P1_18"]
pub type R = crate::R<u32, super::P1_18>;
#[doc = "Writer for register P1_18"]
pub type W = crate::W<u32, super::P1_18>;
#[doc = "Register P1_18 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_18 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[18\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_18 = 0,
    #[doc = "1: It is LOW when the device is configured                                             (non-control endpoints enabled), or when the host is                                             enabled and has detected a device on the bus. It is HIGH                                             when the device is not configured, or when host is                                             enabled and has not detected a device on the bus, or                                             during global suspend. It transitions between LOW and                                             HIGH (flashes) when the host is enabled and detects                                             activity on the bus."]
    USB_UP_LED1 = 1,
    #[doc = "2: Pulse Width Modulator 1, channel 1                                             output."]
    PWM1_1 = 2,
    #[doc = "3: Capture input for Timer 1, channel 0."]
    T1_CAP0 = 3,
    #[doc = "5: Master In Slave Out for SSP1."]
    SSP1_MISO = 5,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_18),
            1 => Val(FUNC_A::USB_UP_LED1),
            2 => Val(FUNC_A::PWM1_1),
            3 => Val(FUNC_A::T1_CAP0),
            5 => Val(FUNC_A::SSP1_MISO),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_18`"]
    #[inline(always)]
    pub fn is_p1_18(&self) -> bool {
        *self == FUNC_A::P1_18
    }
    #[doc = "Checks if the value of the field is `USB_UP_LED1`"]
    #[inline(always)]
    pub fn is_usb_up_led1(&self) -> bool {
        *self == FUNC_A::USB_UP_LED1
    }
    ...
    #[doc = "Checks if the value of the field is `T1_CAP0`"]
    #[inline(always)]
    pub fn is_t1_cap0(&self) -> bool {
        *self == FUNC_A::T1_CAP0
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_18(self) -> &'a mut W {
        self.variant(FUNC_A::P1_18)
    }
    #[doc = "It is LOW when the device is configured (non-control endpoints enabled), or when the host is enabled and has detected a device on the bus. It is HIGH when the device is not configured, or when host is enabled and has not detected a device on the bus, or during global suspend. It transitions between LOW and HIGH (flashes) when the host is enabled and detects activity on the bus."]
    #[inline(always)]
    pub fn usb_up_led1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_UP_LED1)
    }
    #[doc = "Pulse Width Modulator 1, channel 1 output."]
    #[inline(always)]
    pub fn pwm1_1(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_1)
    }
    #[doc = "Capture input for Timer 1, channel 0."]
    #[inline(always)]
    pub fn t1_cap0(self) -> &'a mut W {
        self.variant(FUNC_A::T1_CAP0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[18\\]"]
    #[inline(always)]
