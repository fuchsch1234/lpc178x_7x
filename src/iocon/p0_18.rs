#[doc = "Reader of register P0_18"]
pub type R = crate::R<u32, super::P0_18>;
#[doc = "Writer for register P0_18"]
pub type W = crate::W<u32, super::P0_18>;
#[doc = "Register P0_18 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_18 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[18\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_18 = 0,
    #[doc = "1: Data Carrier Detect input for UART1."]
    U1_DCD = 1,
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P0_18`"]
    #[inline(always)]
    pub fn is_p0_18(&self) -> bool {
        *self == FUNC_A::P0_18
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_18(self) -> &'a mut W {
        self.variant(FUNC_A::P0_18)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[18\\]"]
    #[inline(always)]
