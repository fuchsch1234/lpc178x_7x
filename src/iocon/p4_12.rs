#[doc = "Reader of register P4_12"]
pub type R = crate::R<u32, super::P4_12>;
#[doc = "Writer for register P4_12"]
pub type W = crate::W<u32, super::P4_12>;
#[doc = "Register P4_12 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_12 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[12\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_12 = 0,
    #[doc = "1: External memory address line 12."]
    EMC_A_12 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_12),
            1 => Val(FUNC_A::EMC_A_12),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_12`"]
    #[inline(always)]
    pub fn is_p4_12(&self) -> bool {
        *self == FUNC_A::P4_12
    }
    #[doc = "Checks if the value of the field is `EMC_A_12`"]
    #[inline(always)]
    pub fn is_emc_a_12(&self) -> bool {
        *self == FUNC_A::EMC_A_12
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_12(self) -> &'a mut W {
        self.variant(FUNC_A::P4_12)
    }
    #[doc = "External memory address line 12."]
    #[inline(always)]
    pub fn emc_a_12(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_12)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[12\\]"]
    #[inline(always)]
