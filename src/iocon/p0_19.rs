#[doc = "Reader of register P0_19"]
pub type R = crate::R<u32, super::P0_19>;
#[doc = "Writer for register P0_19"]
pub type W = crate::W<u32, super::P0_19>;
#[doc = "Register P0_19 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_19 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[19\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_19 = 0,
    #[doc = "1: Data Set Ready input for UART1."]
    U1_DSR = 1,
    #[doc = "2: Clock output line for SD card                                             interface."]
    SD_CLK = 2,
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P0_19`"]
    #[inline(always)]
    pub fn is_p0_19(&self) -> bool {
        *self == FUNC_A::P0_19
    }
    ...
    #[doc = "Checks if the value of the field is `SD_CLK`"]
    #[inline(always)]
    pub fn is_sd_clk(&self) -> bool {
        *self == FUNC_A::SD_CLK
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_19(self) -> &'a mut W {
        self.variant(FUNC_A::P0_19)
    }
    ...
    #[doc = "Clock output line for SD card interface."]
    #[inline(always)]
    pub fn sd_clk(self) -> &'a mut W {
        self.variant(FUNC_A::SD_CLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[19\\]"]
    #[inline(always)]
