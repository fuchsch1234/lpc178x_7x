#[doc = "Reader of register P1_12"]
pub type R = crate::R<u32, super::P1_12>;
#[doc = "Writer for register P1_12"]
pub type W = crate::W<u32, super::P1_12>;
#[doc = "Register P1_12 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_12 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[12\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_12 = 0,
    #[doc = "1: Ethernet Receive Data (MII                                             interface)."]
    ENET_RXD3 = 1,
    #[doc = "2: Data line 3 for SD card interface."]
    SD_DAT_3 = 2,
    #[doc = "3: Capture input for PWM0, channel 0."]
    PWM0_CAP0 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_12),
            1 => Val(FUNC_A::ENET_RXD3),
            2 => Val(FUNC_A::SD_DAT_3),
            3 => Val(FUNC_A::PWM0_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_12`"]
    #[inline(always)]
    pub fn is_p1_12(&self) -> bool {
        *self == FUNC_A::P1_12
    }
    #[doc = "Checks if the value of the field is `ENET_RXD3`"]
    #[inline(always)]
    pub fn is_enet_rxd3(&self) -> bool {
        *self == FUNC_A::ENET_RXD3
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_12(self) -> &'a mut W {
        self.variant(FUNC_A::P1_12)
    }
    #[doc = "Ethernet Receive Data (MII interface)."]
    #[inline(always)]
    pub fn enet_rxd3(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_RXD3)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[12\\]"]
    #[inline(always)]
