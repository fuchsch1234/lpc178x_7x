#[doc = "Reader of register P3_26"]
pub type R = crate::R<u32, super::P3_26>;
#[doc = "Writer for register P3_26"]
pub type W = crate::W<u32, super::P3_26>;
#[doc = "Register P3_26 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_26 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[26\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_26 = 0,
    #[doc = "1: External memory data line 26."]
    EMC_D_26 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 3."]
    PWM1_3 = 2,
    #[doc = "3: Match output for Timer 0, channel 1."]
    T0_MAT1 = 3,
    #[doc = "4: System tick timer clock input."]
    STCLK = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_26),
            1 => Val(FUNC_A::EMC_D_26),
            2 => Val(FUNC_A::PWM1_3),
            3 => Val(FUNC_A::T0_MAT1),
            4 => Val(FUNC_A::STCLK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_26`"]
    #[inline(always)]
    pub fn is_p3_26(&self) -> bool {
        *self == FUNC_A::P3_26
    }
    #[doc = "Checks if the value of the field is `EMC_D_26`"]
    #[inline(always)]
    pub fn is_emc_d_26(&self) -> bool {
        *self == FUNC_A::EMC_D_26
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_26(self) -> &'a mut W {
        self.variant(FUNC_A::P3_26)
    }
    #[doc = "External memory data line 26."]
    #[inline(always)]
    pub fn emc_d_26(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_26)
    }
    #[doc = "Pulse Width Modulator 1, output 3."]
    #[inline(always)]
    ...
    #[doc = "System tick timer clock input."]
    #[inline(always)]
    pub fn stclk(self) -> &'a mut W {
        self.variant(FUNC_A::STCLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[26\\]"]
    #[inline(always)]
