#[doc = "Reader of register P4_22"]
pub type R = crate::R<u32, super::P4_22>;
#[doc = "Writer for register P4_22"]
pub type W = crate::W<u32, super::P4_22>;
#[doc = "Register P4_22 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_22 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[22\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_22 = 0,
    #[doc = "1: External memory address line 22."]
    EMC_A_22 = 1,
    #[doc = "2: Transmitter output for UART2."]
    U2_TXD = 2,
    #[doc = "3: Master In Slave Out for SSP1."]
    SSP1_MISO = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_22),
            1 => Val(FUNC_A::EMC_A_22),
            2 => Val(FUNC_A::U2_TXD),
            3 => Val(FUNC_A::SSP1_MISO),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_22`"]
    #[inline(always)]
    pub fn is_p4_22(&self) -> bool {
        *self == FUNC_A::P4_22
    }
    #[doc = "Checks if the value of the field is `EMC_A_22`"]
    #[inline(always)]
    pub fn is_emc_a_22(&self) -> bool {
        *self == FUNC_A::EMC_A_22
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_22(self) -> &'a mut W {
        self.variant(FUNC_A::P4_22)
    }
    #[doc = "External memory address line 22."]
    #[inline(always)]
    pub fn emc_a_22(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_22)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[22\\]"]
    #[inline(always)]
