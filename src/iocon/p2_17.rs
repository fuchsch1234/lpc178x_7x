#[doc = "Reader of register P2_17"]
pub type R = crate::R<u32, super::P2_17>;
#[doc = "Writer for register P2_17"]
pub type W = crate::W<u32, super::P2_17>;
#[doc = "Register P2_17 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_17 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[17\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_17 = 0,
    #[doc = "1: LOW active SDRAM Row Address Strobe."]
    EMC_RAS = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_17),
            1 => Val(FUNC_A::EMC_RAS),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_17`"]
    #[inline(always)]
    pub fn is_p2_17(&self) -> bool {
        *self == FUNC_A::P2_17
    }
    #[doc = "Checks if the value of the field is `EMC_RAS`"]
    #[inline(always)]
    pub fn is_emc_ras(&self) -> bool {
        *self == FUNC_A::EMC_RAS
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_17(self) -> &'a mut W {
        self.variant(FUNC_A::P2_17)
    }
    #[doc = "LOW active SDRAM Row Address Strobe."]
    #[inline(always)]
    pub fn emc_ras(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_RAS)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[17\\]"]
    #[inline(always)]
