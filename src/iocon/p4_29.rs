#[doc = "Reader of register P4_29"]
pub type R = crate::R<u32, super::P4_29>;
#[doc = "Writer for register P4_29"]
pub type W = crate::W<u32, super::P4_29>;
#[doc = "Register P4_29 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_29 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[29\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_29 = 0,
    #[doc = "1: LOW active Byte Lane select signal 3."]
    EMC_BLS3 = 1,
    #[doc = "2: Receiver input for UART3."]
    U3_RXD = 2,
    #[doc = "3: Match output for Timer 2, channel 1."]
    T2_MAT1 = 3,
    #[doc = "4: I2C2 clock                                             input/output (this pin does not use a specialized I2C                                             pad)."]
    I2C2_SCL = 4,
    #[doc = "5: LCD data."]
    LCD_VD_7 = 5,
    #[doc = "6: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P4_29`"]
    #[inline(always)]
    pub fn is_p4_29(&self) -> bool {
        *self == FUNC_A::P4_29
    }
    #[doc = "Checks if the value of the field is `EMC_BLS3`"]
    #[inline(always)]
    pub fn is_emc_bls3(&self) -> bool {
        *self == FUNC_A::EMC_BLS3
    }
    ...
    #[doc = "Checks if the value of the field is `I2C2_SCL`"]
    #[inline(always)]
    pub fn is_i2c2_scl(&self) -> bool {
        *self == FUNC_A::I2C2_SCL
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_29(self) -> &'a mut W {
        self.variant(FUNC_A::P4_29)
    }
    #[doc = "LOW active Byte Lane select signal 3."]
    #[inline(always)]
    pub fn emc_bls3(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_BLS3)
    }
    #[doc = "Receiver input for UART3."]
    #[inline(always)]
    pub fn u3_rxd(self) -> &'a mut W {
        self.variant(FUNC_A::U3_RXD)
    }
    #[doc = "Match output for Timer 2, channel 1."]
    #[inline(always)]
    pub fn t2_mat1(self) -> &'a mut W {
        self.variant(FUNC_A::T2_MAT1)
    }
    #[doc = "I2C2 clock input/output (this pin does not use a specialized I2C pad)."]
    #[inline(always)]
    pub fn i2c2_scl(self) -> &'a mut W {
        self.variant(FUNC_A::I2C2_SCL)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[29\\]"]
    #[inline(always)]
