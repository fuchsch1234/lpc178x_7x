#[doc = "Reader of register P1_1"]
pub type R = crate::R<u32, super::P1_1>;
#[doc = "Writer for register P1_1"]
pub type W = crate::W<u32, super::P1_1>;
#[doc = "Register P1_1 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[1\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_1 = 0,
    #[doc = "1: Ethernet transmit data 1 (RMII/MII                                             interface)."]
    ENET_TXD1 = 1,
    #[doc = "3: Match output for Timer 3, channel 3."]
    T3_MAT3 = 3,
    #[doc = "4: Master Out Slave In for SSP2."]
    SSP2_MOSI = 4,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P1_1),
            1 => Val(FUNC_A::ENET_TXD1),
            3 => Val(FUNC_A::T3_MAT3),
            4 => Val(FUNC_A::SSP2_MOSI),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P1_1`"]
    #[inline(always)]
    pub fn is_p1_1(&self) -> bool {
        *self == FUNC_A::P1_1
    }
    #[doc = "Checks if the value of the field is `ENET_TXD1`"]
    #[inline(always)]
    pub fn is_enet_txd1(&self) -> bool {
        *self == FUNC_A::ENET_TXD1
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_1(self) -> &'a mut W {
        self.variant(FUNC_A::P1_1)
    }
    #[doc = "Ethernet transmit data 1 (RMII/MII interface)."]
    #[inline(always)]
    pub fn enet_txd1(self) -> &'a mut W {
        self.variant(FUNC_A::ENET_TXD1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[1\\]"]
    #[inline(always)]
