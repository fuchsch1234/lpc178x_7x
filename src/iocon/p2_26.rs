#[doc = "Reader of register P2_26"]
pub type R = crate::R<u32, super::P2_26>;
#[doc = "Writer for register P2_26"]
pub type W = crate::W<u32, super::P2_26>;
#[doc = "Register P2_26 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_26 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[26\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_26 = 0,
    #[doc = "1: SDRAM clock enable 2."]
    EMC_CKE2 = 1,
...
impl<'a> FUNC_W<'a> {
    ...
    pub fn p2_26(self) -> &'a mut W {
        self.variant(FUNC_A::P2_26)
    }
    #[doc = "SDRAM clock enable 2."]
    #[inline(always)]
    pub fn emc_cke2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CKE2)
    }
