#[doc = "Reader of register P0_4"]
pub type R = crate::R<u32, super::P0_4>;
#[doc = "Writer for register P0_4"]
pub type W = crate::W<u32, super::P0_4>;
#[doc = "Register P0_4 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_4 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[4\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_4 = 0,
    #[doc = "1: I2S Receive clock. It                                             is driven by the master and received by the slave.                                             Corresponds to the signal SCK in the                                                   I2S-bus                                                 specification."]
    I2S_RX_SCK = 1,
    #[doc = "2: CAN2 receiver input."]
    CAN_RD2 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_4),
            1 => Val(FUNC_A::I2S_RX_SCK),
            2 => Val(FUNC_A::CAN_RD2),
            3 => Val(FUNC_A::T2_CAP0),
            7 => Val(FUNC_A::LCD_VD_0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_4`"]
    #[inline(always)]
    pub fn is_p0_4(&self) -> bool {
        *self == FUNC_A::P0_4
    }
    ...
    #[doc = "Checks if the value of the field is `CAN_RD2`"]
    #[inline(always)]
    pub fn is_can_rd2(&self) -> bool {
        *self == FUNC_A::CAN_RD2
    }
    #[doc = "Checks if the value of the field is `T2_CAP0`"]
    #[inline(always)]
    pub fn is_t2_cap0(&self) -> bool {
        *self == FUNC_A::T2_CAP0
    }
    #[doc = "Checks if the value of the field is `LCD_VD_0`"]
    #[inline(always)]
    pub fn is_lcd_vd_0(&self) -> bool {
        *self == FUNC_A::LCD_VD_0
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_4(self) -> &'a mut W {
        self.variant(FUNC_A::P0_4)
    }
    #[doc = "I2S Receive clock. It is driven by the master and received by the slave. Corresponds to the signal SCK in the I2S-bus specification."]
    #[inline(always)]
    pub fn i2s_rx_sck(self) -> &'a mut W {
        self.variant(FUNC_A::I2S_RX_SCK)
    }
    #[doc = "CAN2 receiver input."]
    #[inline(always)]
    pub fn can_rd2(self) -> &'a mut W {
        self.variant(FUNC_A::CAN_RD2)
    }
    #[doc = "Capture input for Timer 2, channel 0."]
    #[inline(always)]
    pub fn t2_cap0(self) -> &'a mut W {
        self.variant(FUNC_A::T2_CAP0)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_0(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_0)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[4\\]"]
    #[inline(always)]
