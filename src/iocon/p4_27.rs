#[doc = "Reader of register P4_27"]
pub type R = crate::R<u32, super::P4_27>;
#[doc = "Writer for register P4_27"]
pub type W = crate::W<u32, super::P4_27>;
#[doc = "Register P4_27 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_27 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[27\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_27 = 0,
    #[doc = "1: LOW active Byte Lane select signal 1."]
    EMC_BLS1 = 1,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_27),
            1 => Val(FUNC_A::EMC_BLS1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_27`"]
    #[inline(always)]
    pub fn is_p4_27(&self) -> bool {
        *self == FUNC_A::P4_27
    }
    #[doc = "Checks if the value of the field is `EMC_BLS1`"]
    #[inline(always)]
    pub fn is_emc_bls1(&self) -> bool {
        *self == FUNC_A::EMC_BLS1
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_27(self) -> &'a mut W {
        self.variant(FUNC_A::P4_27)
    }
    #[doc = "LOW active Byte Lane select signal 1."]
    #[inline(always)]
    pub fn emc_bls1(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_BLS1)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[27\\]"]
    #[inline(always)]
