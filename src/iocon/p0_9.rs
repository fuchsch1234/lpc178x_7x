#[doc = "Reader of register P0_9"]
pub type R = crate::R<u32, super::P0_9>;
#[doc = "Writer for register P0_9"]
pub type W = crate::W<u32, super::P0_9>;
#[doc = "Register P0_9 `reset()`'s with value 0xa0"]
impl crate::ResetValue for super::P0_9 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[9\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_9 = 0,
    #[doc = "1: I2S transmit data. It                                             is driven by the transmitter and read by the receiver.                                             Corresponds to the signal SD in the                                                   I2S-bus                                                 specification."]
    I2S_TX_SDA = 1,
    #[doc = "2: Master Out Slave In for SSP1."]
    SSP1_MOSI = 2,
    #[doc = "3: Match output for Timer 2, channel 3."]
    T2_MAT3 = 3,
    #[doc = "4: Event input 2 to Event                                             Monitor/Recorder."]
    RTC_EV2 = 4,
    #[doc = "7: LCD data."]
    LCD_VD_17 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_9),
            1 => Val(FUNC_A::I2S_TX_SDA),
            2 => Val(FUNC_A::SSP1_MOSI),
            3 => Val(FUNC_A::T2_MAT3),
            4 => Val(FUNC_A::RTC_EV2),
            7 => Val(FUNC_A::LCD_VD_17),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_9`"]
    #[inline(always)]
    pub fn is_p0_9(&self) -> bool {
        *self == FUNC_A::P0_9
    }
    ...
    #[doc = "Checks if the value of the field is `RTC_EV2`"]
    #[inline(always)]
    pub fn is_rtc_ev2(&self) -> bool {
        *self == FUNC_A::RTC_EV2
    }
    #[doc = "Checks if the value of the field is `LCD_VD_17`"]
    #[inline(always)]
    pub fn is_lcd_vd_17(&self) -> bool {
        *self == FUNC_A::LCD_VD_17
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_9(self) -> &'a mut W {
        self.variant(FUNC_A::P0_9)
    }
    #[doc = "I2S transmit data. It is driven by the transmitter and read by the receiver. Corresponds to the signal SD in the I2S-bus specification."]
    #[inline(always)]
    ...
    #[doc = "Event input 2 to Event Monitor/Recorder."]
    #[inline(always)]
    pub fn rtc_ev2(self) -> &'a mut W {
        self.variant(FUNC_A::RTC_EV2)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_17(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_17)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[9\\]"]
    #[inline(always)]
