#[doc = "Reader of register P2_27"]
pub type R = crate::R<u32, super::P2_27>;
#[doc = "Writer for register P2_27"]
pub type W = crate::W<u32, super::P2_27>;
#[doc = "Register P2_27 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_27 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[27\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_27 = 0,
    #[doc = "1: SDRAM clock enable 3."]
    EMC_CKE3 = 1,
    #[doc = "2: Master Out Slave In for SSP0."]
    SSP0_MOSI = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P2_27),
            1 => Val(FUNC_A::EMC_CKE3),
            2 => Val(FUNC_A::SSP0_MOSI),
            3 => Val(FUNC_A::T3_MAT1),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_27`"]
    #[inline(always)]
    pub fn is_p2_27(&self) -> bool {
        *self == FUNC_A::P2_27
    }
    #[doc = "Checks if the value of the field is `EMC_CKE3`"]
    #[inline(always)]
    pub fn is_emc_cke3(&self) -> bool {
        *self == FUNC_A::EMC_CKE3
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_27(self) -> &'a mut W {
        self.variant(FUNC_A::P2_27)
    }
    #[doc = "SDRAM clock enable 3."]
    #[inline(always)]
    pub fn emc_cke3(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_CKE3)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[27\\]"]
    #[inline(always)]
