#[doc = "Reader of register P3_16"]
pub type R = crate::R<u32, super::P3_16>;
#[doc = "Writer for register P3_16"]
pub type W = crate::W<u32, super::P3_16>;
#[doc = "Register P3_16 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_16 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[16\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_16 = 0,
    #[doc = "1: External memory data line 16."]
    EMC_D_16 = 1,
    #[doc = "2: Pulse Width Modulator 0, output 1."]
    PWM0_1 = 2,
    #[doc = "3: Transmitter output for UART1."]
    U1_TXD = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_16),
            1 => Val(FUNC_A::EMC_D_16),
            2 => Val(FUNC_A::PWM0_1),
            3 => Val(FUNC_A::U1_TXD),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_16`"]
    #[inline(always)]
    pub fn is_p3_16(&self) -> bool {
        *self == FUNC_A::P3_16
    }
    #[doc = "Checks if the value of the field is `EMC_D_16`"]
    #[inline(always)]
    pub fn is_emc_d_16(&self) -> bool {
        *self == FUNC_A::EMC_D_16
    }
    ...
    #[doc = "Checks if the value of the field is `U1_TXD`"]
    #[inline(always)]
    pub fn is_u1_txd(&self) -> bool {
        *self == FUNC_A::U1_TXD
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_16(self) -> &'a mut W {
        self.variant(FUNC_A::P3_16)
    }
    #[doc = "External memory data line 16."]
    #[inline(always)]
    pub fn emc_d_16(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_16)
    }
    ...
    #[doc = "Transmitter output for UART1."]
    #[inline(always)]
    pub fn u1_txd(self) -> &'a mut W {
        self.variant(FUNC_A::U1_TXD)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[16\\]"]
    #[inline(always)]
