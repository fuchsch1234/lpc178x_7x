#[doc = "Reader of register P2_2"]
pub type R = crate::R<u32, super::P2_2>;
#[doc = "Writer for register P2_2"]
pub type W = crate::W<u32, super::P2_2>;
#[doc = "Register P2_2 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_2 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[2\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_2 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 3                                             output."]
    PWM1_3 = 1,
    #[doc = "2: Clear to Send input for UART1."]
    U1_CTS = 2,
    #[doc = "3: Match output for Timer 2, channel 3."]
    T2_MAT3 = 3,
    #[doc = "5: Trace data, bit 3."]
    TRACEDATA_3 = 5,
    #[doc = "7: LCD panel clock."]
    LCD_DCLK = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            1 => Val(FUNC_A::PWM1_3),
            2 => Val(FUNC_A::U1_CTS),
            3 => Val(FUNC_A::T2_MAT3),
            5 => Val(FUNC_A::TRACEDATA_3),
            7 => Val(FUNC_A::LCD_DCLK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_2`"]
    #[inline(always)]
    pub fn is_p2_2(&self) -> bool {
        *self == FUNC_A::P2_2
    }
    ...
    #[doc = "Checks if the value of the field is `T2_MAT3`"]
    #[inline(always)]
    pub fn is_t2_mat3(&self) -> bool {
        *self == FUNC_A::T2_MAT3
    }
    #[doc = "Checks if the value of the field is `TRACEDATA_3`"]
    #[inline(always)]
    pub fn is_tracedata_3(&self) -> bool {
        *self == FUNC_A::TRACEDATA_3
    }
    #[doc = "Checks if the value of the field is `LCD_DCLK`"]
    #[inline(always)]
    pub fn is_lcd_dclk(&self) -> bool {
        *self == FUNC_A::LCD_DCLK
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_2(self) -> &'a mut W {
        self.variant(FUNC_A::P2_2)
    }
    ...
    #[doc = "Match output for Timer 2, channel 3."]
    #[inline(always)]
    pub fn t2_mat3(self) -> &'a mut W {
        self.variant(FUNC_A::T2_MAT3)
    }
    #[doc = "Trace data, bit 3."]
    #[inline(always)]
    pub fn tracedata_3(self) -> &'a mut W {
        self.variant(FUNC_A::TRACEDATA_3)
    }
    #[doc = "LCD panel clock."]
    #[inline(always)]
    pub fn lcd_dclk(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_DCLK)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[2\\]"]
    #[inline(always)]
