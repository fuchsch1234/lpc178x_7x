#[doc = "Reader of register P1_23"]
pub type R = crate::R<u32, super::P1_23>;
#[doc = "Writer for register P1_23"]
pub type W = crate::W<u32, super::P1_23>;
#[doc = "Register P1_23 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_23 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[23\\]\n\nValue on reset: 0"]
...
pub enum FUNC_A {
    ...
    USB_RX_DP1 = 1,
    #[doc = "2: Pulse Width Modulator 1, channel 4                                             output."]
    PWM1_4 = 2,
    #[doc = "3: Quadrature Encoder Interface PHB                                             input."]
    QEI_PHB = 3,
    #[doc = "4: Motor control PWM channel 1 feedback                                             input."]
    MC_FB1 = 4,
    #[doc = "5: Master In Slave Out for SSP0."]
    SSP0_MISO = 5,
    #[doc = "6: LCD data."]
    LCD_VD_9 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_23`"]
    #[inline(always)]
    pub fn is_p1_23(&self) -> bool {
        *self == FUNC_A::P1_23
    }
    #[doc = "Checks if the value of the field is `USB_RX_DP1`"]
    #[inline(always)]
    pub fn is_usb_rx_dp1(&self) -> bool {
        *self == FUNC_A::USB_RX_DP1
    }
    #[doc = "Checks if the value of the field is `PWM1_4`"]
    #[inline(always)]
    pub fn is_pwm1_4(&self) -> bool {
        *self == FUNC_A::PWM1_4
    }
    #[doc = "Checks if the value of the field is `QEI_PHB`"]
    #[inline(always)]
    pub fn is_qei_phb(&self) -> bool {
        *self == FUNC_A::QEI_PHB
    }
    #[doc = "Checks if the value of the field is `MC_FB1`"]
    #[inline(always)]
    pub fn is_mc_fb1(&self) -> bool {
        *self == FUNC_A::MC_FB1
    }
    #[doc = "Checks if the value of the field is `SSP0_MISO`"]
    #[inline(always)]
    pub fn is_ssp0_miso(&self) -> bool {
        *self == FUNC_A::SSP0_MISO
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_23(self) -> &'a mut W {
        self.variant(FUNC_A::P1_23)
    }
    #[doc = "D+ receive data for USB port 1 (OTG transceiver)."]
    #[inline(always)]
    pub fn usb_rx_dp1(self) -> &'a mut W {
        self.variant(FUNC_A::USB_RX_DP1)
    }
    #[doc = "Pulse Width Modulator 1, channel 4 output."]
    #[inline(always)]
    pub fn pwm1_4(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_4)
    }
    #[doc = "Quadrature Encoder Interface PHB input."]
    #[inline(always)]
    pub fn qei_phb(self) -> &'a mut W {
        self.variant(FUNC_A::QEI_PHB)
    }
    #[doc = "Motor control PWM channel 1 feedback input."]
    #[inline(always)]
    pub fn mc_fb1(self) -> &'a mut W {
        self.variant(FUNC_A::MC_FB1)
    }
    #[doc = "Master In Slave Out for SSP0."]
    #[inline(always)]
    pub fn ssp0_miso(self) -> &'a mut W {
        self.variant(FUNC_A::SSP0_MISO)
    }
    #[doc = "LCD data."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[23\\]"]
    #[inline(always)]
