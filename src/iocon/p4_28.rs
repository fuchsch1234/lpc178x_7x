#[doc = "Reader of register P4_28"]
pub type R = crate::R<u32, super::P4_28>;
#[doc = "Writer for register P4_28"]
pub type W = crate::W<u32, super::P4_28>;
#[doc = "Register P4_28 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_28 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P4\\[28\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P4_28 = 0,
    #[doc = "1: LOW active Byte Lane select signal 2."]
    EMC_BLS2 = 1,
    #[doc = "2: Transmitter output for UART3."]
    U3_TXD = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_28),
            1 => Val(FUNC_A::EMC_BLS2),
            2 => Val(FUNC_A::U3_TXD),
            3 => Val(FUNC_A::T2_MAT0),
            5 => Val(FUNC_A::LCD_VD_6),
            6 => Val(FUNC_A::LCD_VD_10),
            7 => Val(FUNC_A::LCD_VD_2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_28`"]
    #[inline(always)]
    pub fn is_p4_28(&self) -> bool {
        *self == FUNC_A::P4_28
    }
    #[doc = "Checks if the value of the field is `EMC_BLS2`"]
    #[inline(always)]
    pub fn is_emc_bls2(&self) -> bool {
        *self == FUNC_A::EMC_BLS2
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_VD_2`"]
    #[inline(always)]
    pub fn is_lcd_vd_2(&self) -> bool {
        *self == FUNC_A::LCD_VD_2
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_28(self) -> &'a mut W {
        self.variant(FUNC_A::P4_28)
    }
    #[doc = "LOW active Byte Lane select signal 2."]
    #[inline(always)]
    pub fn emc_bls2(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_BLS2)
    }
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_2(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[28\\]"]
    #[inline(always)]
