#[doc = "Reader of register P2_3"]
pub type R = crate::R<u32, super::P2_3>;
#[doc = "Writer for register P2_3"]
pub type W = crate::W<u32, super::P2_3>;
#[doc = "Register P2_3 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P2_3 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P2\\[3\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P2_3 = 0,
    #[doc = "1: Pulse Width Modulator 1, channel 4                                             output."]
    PWM1_4 = 1,
    #[doc = "2: Data Carrier Detect input for UART1."]
    U1_DCD = 2,
    #[doc = "3: Match output for Timer 2, channel 2."]
    T2_MAT2 = 3,
    #[doc = "5: Trace data, bit 2."]
    TRACEDATA_2 = 5,
    #[doc = "7: Frame pulse (STN). Vertical synchronization pulse                                             (TFT)."]
    LCD_FP = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNC_A::TRACEDATA_2),
            7 => Val(FUNC_A::LCD_FP),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P2_3`"]
    #[inline(always)]
    pub fn is_p2_3(&self) -> bool {
        *self == FUNC_A::P2_3
    }
    ...
    #[doc = "Checks if the value of the field is `U1_DCD`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `TRACEDATA_2`"]
    #[inline(always)]
    pub fn is_tracedata_2(&self) -> bool {
        *self == FUNC_A::TRACEDATA_2
    }
    #[doc = "Checks if the value of the field is `LCD_FP`"]
    #[inline(always)]
    pub fn is_lcd_fp(&self) -> bool {
        *self == FUNC_A::LCD_FP
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p2_3(self) -> &'a mut W {
        self.variant(FUNC_A::P2_3)
    }
    ...
    #[inline(always)]
    pub fn u1_dcd(self) -> &'a mut W {
        self.variant(FUNC_A::U1_DCD)
    }
    ...
    #[doc = "Trace data, bit 2."]
    #[inline(always)]
    pub fn tracedata_2(self) -> &'a mut W {
        self.variant(FUNC_A::TRACEDATA_2)
    }
    #[doc = "Frame pulse (STN). Vertical synchronization pulse (TFT)."]
    #[inline(always)]
    pub fn lcd_fp(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_FP)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P2\\[3\\]"]
    #[inline(always)]
