#[doc = "Reader of register P3_21"]
pub type R = crate::R<u32, super::P3_21>;
#[doc = "Writer for register P3_21"]
pub type W = crate::W<u32, super::P3_21>;
#[doc = "Register P3_21 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_21 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[21\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_21 = 0,
    #[doc = "1: External memory data line 21."]
    EMC_D_21 = 1,
    #[doc = "2: Pulse Width Modulator 0, output 6."]
    PWM0_6 = 2,
    #[doc = "3: Data Terminal Ready output for UART1. Can also be                                             configured to be an RS-485/EIA-485 output enable signal                                             for UART1."]
    U1_DTR = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_21),
            1 => Val(FUNC_A::EMC_D_21),
            2 => Val(FUNC_A::PWM0_6),
            3 => Val(FUNC_A::U1_DTR),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_21`"]
    #[inline(always)]
    pub fn is_p3_21(&self) -> bool {
        *self == FUNC_A::P3_21
    }
    #[doc = "Checks if the value of the field is `EMC_D_21`"]
    #[inline(always)]
    pub fn is_emc_d_21(&self) -> bool {
        *self == FUNC_A::EMC_D_21
    }
    #[doc = "Checks if the value of the field is `PWM0_6`"]
    #[inline(always)]
    pub fn is_pwm0_6(&self) -> bool {
        *self == FUNC_A::PWM0_6
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_21(self) -> &'a mut W {
        self.variant(FUNC_A::P3_21)
    }
    #[doc = "External memory data line 21."]
    #[inline(always)]
    pub fn emc_d_21(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_21)
    }
    #[doc = "Pulse Width Modulator 0, output 6."]
    #[inline(always)]
    pub fn pwm0_6(self) -> &'a mut W {
        self.variant(FUNC_A::PWM0_6)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[21\\]"]
    #[inline(always)]
