#[doc = "Reader of register P3_27"]
pub type R = crate::R<u32, super::P3_27>;
#[doc = "Writer for register P3_27"]
pub type W = crate::W<u32, super::P3_27>;
#[doc = "Register P3_27 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P3_27 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P3\\[27\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P3_27 = 0,
    #[doc = "1: External memory data line 27."]
    EMC_D_27 = 1,
    #[doc = "2: Pulse Width Modulator 1, output 4."]
    PWM1_4 = 2,
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P3_27),
            1 => Val(FUNC_A::EMC_D_27),
            2 => Val(FUNC_A::PWM1_4),
            3 => Val(FUNC_A::T1_CAP0),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P3_27`"]
    #[inline(always)]
    pub fn is_p3_27(&self) -> bool {
        *self == FUNC_A::P3_27
    }
    #[doc = "Checks if the value of the field is `EMC_D_27`"]
    #[inline(always)]
    pub fn is_emc_d_27(&self) -> bool {
        *self == FUNC_A::EMC_D_27
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p3_27(self) -> &'a mut W {
        self.variant(FUNC_A::P3_27)
    }
    #[doc = "External memory data line 27."]
    #[inline(always)]
    pub fn emc_d_27(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_D_27)
    }
    #[doc = "Pulse Width Modulator 1, output 4."]
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P3\\[27\\]"]
    #[inline(always)]
