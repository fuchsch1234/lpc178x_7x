#[doc = "Reader of register P0_14"]
pub type R = crate::R<u32, super::P0_14>;
#[doc = "Writer for register P0_14"]
pub type W = crate::W<u32, super::P0_14>;
#[doc = "Register P0_14 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P0_14 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[14\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_14 = 0,
    #[doc = "1: Host Enabled status for USB port 2."]
    USB_HSTEN2 = 1,
    #[doc = "2: Slave Select for SSP1."]
    SSP1_SSEL = 2,
    #[doc = "3: SoftConnect control for USB port 2. Signal used                                             to switch an external 1.5 kW                                             resistor under software control. Used with the                                             SoftConnect USB feature."]
    USB_CONNECT2 = 3,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_14),
            1 => Val(FUNC_A::USB_HSTEN2),
            2 => Val(FUNC_A::SSP1_SSEL),
            3 => Val(FUNC_A::USB_CONNECT2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P0_14`"]
    #[inline(always)]
    pub fn is_p0_14(&self) -> bool {
        *self == FUNC_A::P0_14
    }
    #[doc = "Checks if the value of the field is `USB_HSTEN2`"]
    #[inline(always)]
    pub fn is_usb_hsten2(&self) -> bool {
        *self == FUNC_A::USB_HSTEN2
    }
    ...
    #[doc = "Checks if the value of the field is `USB_CONNECT2`"]
    #[inline(always)]
    pub fn is_usb_connect2(&self) -> bool {
        *self == FUNC_A::USB_CONNECT2
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p0_14(self) -> &'a mut W {
        self.variant(FUNC_A::P0_14)
    }
    #[doc = "Host Enabled status for USB port 2."]
    #[inline(always)]
    pub fn usb_hsten2(self) -> &'a mut W {
        self.variant(FUNC_A::USB_HSTEN2)
    }
    ...
    #[doc = "SoftConnect control for USB port 2. Signal used to switch an external 1.5 kW resistor under software control. Used with the SoftConnect USB feature."]
    #[inline(always)]
    pub fn usb_connect2(self) -> &'a mut W {
        self.variant(FUNC_A::USB_CONNECT2)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P0\\[14\\]"]
    #[inline(always)]
