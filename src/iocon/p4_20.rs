#[doc = "Reader of register P4_20"]
pub type R = crate::R<u32, super::P4_20>;
#[doc = "Writer for register P4_20"]
pub type W = crate::W<u32, super::P4_20>;
#[doc = "Register P4_20 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P4_20 {
    type Type = u32;
    #[inline(always)]
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P4_20),
            1 => Val(FUNC_A::EMC_A_20),
            2 => Val(FUNC_A::I2C2_SDA),
            3 => Val(FUNC_A::SSP1_SCK),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `P4_20`"]
    #[inline(always)]
    pub fn is_p4_20(&self) -> bool {
        *self == FUNC_A::P4_20
    }
    #[doc = "Checks if the value of the field is `EMC_A_20`"]
    #[inline(always)]
    pub fn is_emc_a_20(&self) -> bool {
        *self == FUNC_A::EMC_A_20
    }
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p4_20(self) -> &'a mut W {
        self.variant(FUNC_A::P4_20)
    }
    #[doc = "External memory address line 20."]
    #[inline(always)]
    pub fn emc_a_20(self) -> &'a mut W {
        self.variant(FUNC_A::EMC_A_20)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P4\\[20\\]"]
    #[inline(always)]
