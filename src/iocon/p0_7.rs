#[doc = "Reader of register P0_7"]
pub type R = crate::R<u32, super::P0_7>;
#[doc = "Writer for register P0_7"]
pub type W = crate::W<u32, super::P0_7>;
#[doc = "Register P0_7 `reset()`'s with value 0xa0"]
impl crate::ResetValue for super::P0_7 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P0\\[7\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P0_7 = 0,
    #[doc = "1: I2S transmit clock. It                                             is driven by the master and received by the slave.                                             Corresponds to the signal SCK in the                                                   I2S-bus                                                 specification."]
    I2S_TX_SCK = 1,
    #[doc = "2: Serial Clock for SSP1."]
    SSP1_SCK = 2,
    #[doc = "3: Match output for Timer 2, channel 1."]
    T2_MAT1 = 3,
    #[doc = "4: Event input 0 to Event                                             Monitor/Recorder."]
    RTC_EV0 = 4,
    #[doc = "7: LCD data."]
    LCD_VD_9 = 7,
}
...
impl FUNC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNC_A> {
        ...
        match self.bits {
            0 => Val(FUNC_A::P0_7),
            1 => Val(FUNC_A::I2S_TX_SCK),
            2 => Val(FUNC_A::SSP1_SCK),
            3 => Val(FUNC_A::T2_MAT1),
            4 => Val(FUNC_A::RTC_EV0),
            7 => Val(FUNC_A::LCD_VD_9),
            i => Res(i),
        }
    }
