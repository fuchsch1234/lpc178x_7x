#[doc = "Reader of register P1_28"]
pub type R = crate::R<u32, super::P1_28>;
#[doc = "Writer for register P1_28"]
pub type W = crate::W<u32, super::P1_28>;
#[doc = "Register P1_28 `reset()`'s with value 0x30"]
impl crate::ResetValue for super::P1_28 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Selects pin function for pin P1\\[28\\]\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: General purpose digital input/output\r\n                                            pin."]
    P1_28 = 0,
    #[doc = "1: USB port 1 I2C serial                                             clock (OTG transceiver)."]
    USB_SCL1 = 1,
    #[doc = "2: Capture input for PWM1, channel 0."]
    PWM1_CAP0 = 2,
    #[doc = "3: Match output for Timer 0, channel 0."]
    T0_MAT0 = 3,
    #[doc = "4: Motor control PWM channel 2, output                                             A."]
    MC_2A = 4,
    #[doc = "5: Slave Select for SSP0."]
    SSP0_SSEL = 5,
    #[doc = "6: LCD data."]
    LCD_VD_14 = 6,
    #[doc = "7: LCD data."]
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `P1_28`"]
    #[inline(always)]
    pub fn is_p1_28(&self) -> bool {
        *self == FUNC_A::P1_28
    }
    ...
    #[doc = "Checks if the value of the field is `PWM1_CAP0`"]
    #[inline(always)]
    pub fn is_pwm1_cap0(&self) -> bool {
        *self == FUNC_A::PWM1_CAP0
    }
    ...
    #[doc = "Checks if the value of the field is `MC_2A`"]
    #[inline(always)]
    pub fn is_mc_2a(&self) -> bool {
        *self == FUNC_A::MC_2A
    }
    ...
    #[doc = "Checks if the value of the field is `LCD_VD_14`"]
    #[inline(always)]
    pub fn is_lcd_vd_14(&self) -> bool {
        *self == FUNC_A::LCD_VD_14
    }
    #[doc = "Checks if the value of the field is `LCD_VD_22`"]
    #[inline(always)]
    pub fn is_lcd_vd_22(&self) -> bool {
        *self == FUNC_A::LCD_VD_22
    }
}
...
impl<'a> FUNC_W<'a> {
    ...
    #[inline(always)]
    pub fn p1_28(self) -> &'a mut W {
        self.variant(FUNC_A::P1_28)
    }
    #[doc = "USB port 1 I2C serial clock (OTG transceiver)."]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn pwm1_cap0(self) -> &'a mut W {
        self.variant(FUNC_A::PWM1_CAP0)
    }
    #[doc = "Match output for Timer 0, channel 0."]
    #[inline(always)]
    pub fn t0_mat0(self) -> &'a mut W {
        self.variant(FUNC_A::T0_MAT0)
    }
    #[doc = "Motor control PWM channel 2, output A."]
    #[inline(always)]
    pub fn mc_2a(self) -> &'a mut W {
        self.variant(FUNC_A::MC_2A)
    }
    ...
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_14(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_14)
    }
    #[doc = "LCD data."]
    #[inline(always)]
    pub fn lcd_vd_22(self) -> &'a mut W {
        self.variant(FUNC_A::LCD_VD_22)
    }
...
impl R {
    #[doc = "Bits 0:2 - Selects pin function for pin P1\\[28\\]"]
    #[inline(always)]
