...
#[doc = "DMA Channel 0 Control Register"]
pub mod control;
#[doc = "DMA Channel 0 Configuration Register\\[1\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cconfig](cconfig) module"]
pub type CCONFIG = crate::Reg<u32, _CCONFIG>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CCONFIG;
#[doc = "`read()` method returns [cconfig::R](cconfig::R) reader structure"]
impl crate::Readable for CCONFIG {}
#[doc = "`write(|w| ..)` method takes [cconfig::W](cconfig::W) writer structure"]
impl crate::Writable for CCONFIG {}
#[doc = "DMA Channel 0 Configuration Register\\[1\\]"]
pub mod cconfig;
