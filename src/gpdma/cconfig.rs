#[doc = "Reader of register CCONFIG%s"]
pub type R = crate::R<u32, super::CCONFIG>;
#[doc = "Writer for register CCONFIG%s"]
pub type W = crate::W<u32, super::CCONFIG>;
#[doc = "Register CCONFIG%s `reset()`'s with value 0"]
impl crate::ResetValue for super::CCONFIG {
    type Type = u32;
    #[inline(always)]
