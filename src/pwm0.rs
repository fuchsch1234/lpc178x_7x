...
#[doc = "PWM Control Register. Enables PWM outputs and selects either single edge or double edge controlled PWM outputs."]
pub mod cr;
#[doc = "Match Register. Match registers are continuously compared to the PWM counter in order to control PWM output edges.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mr_](mr_) module"]
pub type MR_ = crate::Reg<u32, _MR_>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _MR_;
#[doc = "`read()` method returns [mr_::R](mr_::R) reader structure"]
impl crate::Readable for MR_ {}
#[doc = "`write(|w| ..)` method takes [mr_::W](mr_::W) writer structure"]
impl crate::Writable for MR_ {}
#[doc = "Match Register. Match registers are continuously compared to the PWM counter in order to control PWM output edges."]
pub mod mr_;
