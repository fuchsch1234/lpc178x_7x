#[doc = "Reader of register CCP"]
pub type R = crate::R<u32, super::CCP>;
#[doc = "Writer for register CCP"]
pub type W = crate::W<u32, super::CCP>;
#[doc = "Register CCP `reset()`'s with value 0"]
impl crate::ResetValue for super::CCP {
    type Type = u32;
    #[inline(always)]
