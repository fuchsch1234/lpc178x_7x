...
#[doc = "Dead time register"]
pub mod dt;
#[doc = "Communication Pattern register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ccp](ccp) module"]
pub type CCP = crate::Reg<u32, _CCP>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CCP;
#[doc = "`read()` method returns [ccp::R](ccp::R) reader structure"]
impl crate::Readable for CCP {}
#[doc = "`write(|w| ..)` method takes [ccp::W](ccp::W) writer structure"]
impl crate::Writable for CCP {}
#[doc = "Communication Pattern register"]
pub mod ccp;
