...
#[doc = "Alarm value for Year"]
pub mod ayrs;
#[doc = "Event Monitor/Recorder Control register. Contains bits that control actions for the event channels as well as for Event Monitor/Recorder setup.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ercontrol](ercontrol) module"]
pub type ERCONTROL = crate::Reg<u32, _ERCONTROL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ERCONTROL;
#[doc = "`read()` method returns [ercontrol::R](ercontrol::R) reader structure"]
impl crate::Readable for ERCONTROL {}
#[doc = "`write(|w| ..)` method takes [ercontrol::W](ercontrol::W) writer structure"]
impl crate::Writable for ERCONTROL {}
#[doc = "Event Monitor/Recorder Control register. Contains bits that control actions for the event channels as well as for Event Monitor/Recorder setup."]
pub mod ercontrol;
#[doc = "Event Monitor/Recorder Status register. Contains status flags for event channels and other Event Monitor/Recorder conditions.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [erstatus](erstatus) module"]
pub type ERSTATUS = crate::Reg<u32, _ERSTATUS>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ERSTATUS;
#[doc = "`read()` method returns [erstatus::R](erstatus::R) reader structure"]
impl crate::Readable for ERSTATUS {}
#[doc = "`write(|w| ..)` method takes [erstatus::W](erstatus::W) writer structure"]
impl crate::Writable for ERSTATUS {}
#[doc = "Event Monitor/Recorder Status register. Contains status flags for event channels and other Event Monitor/Recorder conditions."]
pub mod erstatus;
#[doc = "Event Monitor/Recorder Counters register. Allows reading the counters associated with the event channels.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ercounters](ercounters) module"]
pub type ERCOUNTERS = crate::Reg<u32, _ERCOUNTERS>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ERCOUNTERS;
#[doc = "`read()` method returns [ercounters::R](ercounters::R) reader structure"]
impl crate::Readable for ERCOUNTERS {}
#[doc = "Event Monitor/Recorder Counters register. Allows reading the counters associated with the event channels."]
pub mod ercounters;
#[doc = "Event Monitor/Recorder First Stamp register for channel 0. Retains the time stamp for the first event on channel 0.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [erfirststamp](erfirststamp) module"]
pub type ERFIRSTSTAMP = crate::Reg<u32, _ERFIRSTSTAMP>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ERFIRSTSTAMP;
#[doc = "`read()` method returns [erfirststamp::R](erfirststamp::R) reader structure"]
impl crate::Readable for ERFIRSTSTAMP {}
#[doc = "Event Monitor/Recorder First Stamp register for channel 0. Retains the time stamp for the first event on channel 0."]
pub mod erfirststamp;
#[doc = "Event Monitor/Recorder Last Stamp register for channel 0. Retains the time stamp for the last (i.e. most recent) event on channel 0.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [erlaststamp](erlaststamp) module"]
pub type ERLASTSTAMP = crate::Reg<u32, _ERLASTSTAMP>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _ERLASTSTAMP;
#[doc = "`read()` method returns [erlaststamp::R](erlaststamp::R) reader structure"]
impl crate::Readable for ERLASTSTAMP {}
#[doc = "Event Monitor/Recorder Last Stamp register for channel 0. Retains the time stamp for the last (i.e. most recent) event on channel 0."]
pub mod erlaststamp;
