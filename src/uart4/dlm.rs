...
#[doc = "Register DLM `reset()`'s with value 0x01"]
...
impl R {
    #[doc = "Bits 0:7 - The UART4 Divisor Latch MSB Register, along with the U0DLL register, determines the baud rate of the UART4."]
    #[inline(always)]
