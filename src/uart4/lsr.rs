...
impl BI_R {
    ...
    pub fn variant(&self) -> BI_A {
        match self.bits {
            false => BI_A::NO_BREAK_INTERRUPT,
            true => BI_A::BREAK_INTERRUPT,
        }
    }
    #[doc = "Checks if the value of the field is `NO_BREAK_INTERRUPT`"]
    #[inline(always)]
    pub fn is_no_break_interrupt(&self) -> bool {
        *self == BI_A::NO_BREAK_INTERRUPT
    }
    #[doc = "Checks if the value of the field is `BREAK_INTERRUPT`"]
    #[inline(always)]
    pub fn is_break_interrupt(&self) -> bool {
        *self == BI_A::BREAK_INTERRUPT
    }
}
