#[doc = "Reader of register FILTERPHA"]
pub type R = crate::R<u32, super::FILTERPHA>;
#[doc = "Writer for register FILTERPHA"]
pub type W = crate::W<u32, super::FILTERPHA>;
#[doc = "Register FILTERPHA `reset()`'s with value 0"]
impl crate::ResetValue for super::FILTERPHA {
    type Type = u32;
    #[inline(always)]
