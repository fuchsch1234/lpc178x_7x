#[doc = "Reader of register CRSR_PAL1"]
pub type R = crate::R<u32, super::CRSR_PAL1>;
#[doc = "Writer for register CRSR_PAL1"]
pub type W = crate::W<u32, super::CRSR_PAL1>;
#[doc = "Register CRSR_PAL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CRSR_PAL1 {
    type Type = u32;
    #[inline(always)]
