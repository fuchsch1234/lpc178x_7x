#[doc = "Reader of register DATATIMER"]
pub type R = crate::R<u32, super::DATATIMER>;
#[doc = "Writer for register DATATIMER"]
pub type W = crate::W<u32, super::DATATIMER>;
#[doc = "Register DATATIMER `reset()`'s with value 0"]
impl crate::ResetValue for super::DATATIMER {
    type Type = u32;
    #[inline(always)]
