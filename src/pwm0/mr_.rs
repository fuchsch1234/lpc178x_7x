#[doc = "Reader of register MR_%s"]
pub type R = crate::R<u32, super::MR_>;
#[doc = "Writer for register MR_%s"]
pub type W = crate::W<u32, super::MR_>;
#[doc = "Register MR_%s `reset()`'s with value 0"]
impl crate::ResetValue for super::MR_ {
    type Type = u32;
    #[inline(always)]
